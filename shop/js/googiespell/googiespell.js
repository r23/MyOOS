/****
Last Modified: 01/08/06 23:32:13
...
GoogieSpell.prototype.showErrorWindow = function(elm, id) {
  ...
  var link = GoogieSpell.createFocusLink();
...
GoogieSpell.prototype.showErrorsInIframe = function() {
  ...
  this.focus_link_t = GoogieSpell.createFocusLink();
  this.focus_link_b = GoogieSpell.createFocusLink();
...
GoogieSpell.createFocusLink = function() {
  return AJS.A({'href': 'javascript:;'}, AJS.IMG({'src': this.img_dir + 'blank.gif',
