...
var efa_bigger = ['',					//HTML to go before 'bigger' link
				  '<img src="js/efa/16b_zoomIn.gif" class="efa"/>',				//HTML to go inside 'bigger' anchor tag
...
var efa_reset = ['',
				 '<img src="js/efa/16b_normal.gif" class="efa"/>',				//HTML to go before 'reset' link
...
var efa_smaller = ['',
				   '<img src="js/efa/16b_zoomOut.gif" class="efa"/>',				//HTML to go before 'smaller' link
