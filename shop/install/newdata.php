...
$result = $db->Execute("INSERT INTO " . $prefix_table . "block (block_id, block_side, block_status, block_file, block_cache, block_type, block_sort_order, block_login_flag, date_added, last_modified, set_function) VALUES (13, 'sidebar', 1, 'shopping_cart', '', 1, 13, 0, " . $db->DBTimeStamp($today) . ", NULL, 'oos_block_select_option(array(\'left\', \'sidebar\'),')") OR die ("<b>".NOTUPDATED . $prefix_table . "block</b>");
...
$result = $db->Execute("INSERT INTO " . $prefix_table . "block (block_id, block_side, block_status, block_file, block_cache, block_type, block_sort_order, block_login_flag, date_added, last_modified, set_function) VALUES (17, 'sidebar', 1, 'order_history', '', 1, 17, 1, " . $db->DBTimeStamp($today) . ", NULL, 'oos_block_select_option(array(\'left\', \'sidebar\'),')") OR die ("<b>".NOTUPDATED . $prefix_table . "block</b>");
...
$result = $db->Execute("INSERT INTO " . $prefix_table . "block (block_id, block_side, block_status, block_file, block_cache, block_type, block_sort_order, block_login_flag, date_added, last_modified, set_function) VALUES (23, 'sidebar', 0, 'reviews', '', 1, 23, 0, " . $db->DBTimeStamp($today) . ", NULL, 'oos_block_select_option(array(\'left\', \'sidebar\'),')") OR die ("<b>".NOTUPDATED . $prefix_table . "block</b>");
...
$result = $db->Execute("INSERT INTO " . $prefix_table . "block (block_id, block_side, block_status, block_file, block_cache, block_type, block_sort_order, block_login_flag, date_added, last_modified, set_function) VALUES (30, 'sidebar', 0, 'newsletter', 'system', 1, 30, 0, " . $db->DBTimeStamp($today) . ",  NULL, 'oos_block_select_option(array(\'left\', \'sidebar\'),')") OR die ("<b>".NOTUPDATED . $prefix_table . "block</b>");
...
$result = $db->Execute("INSERT INTO " . $prefix_table . "information_description (information_id, information_languages_id, information_name, information_heading_title, information_description) VALUES (1, 1, 'Impressum', 'Impressum', 'F&uuml;gen Sie hier Ihre Informationen zum Impressum ein.' )") OR die ("<b>".NOTUPDATED . $prefix_table . "information_description</b>");
...
$result = $db->Execute("INSERT INTO " . $prefix_table . "information_description (information_id, information_languages_id, information_name, information_heading_title, information_description) VALUES (2, 1, 'AGB', 'Unsere AGB', 'F&uuml;gen Sie hier Ihre AGB ein' )") OR die ("<b>".NOTUPDATED . $prefix_table . "information_description</b>");
...
$result = $db->Execute("INSERT INTO " . $prefix_table . "information_description (information_id, information_languages_id, information_name, information_heading_title, information_description) VALUES (3, 1, 'Widerrufsbelehrung ', 'Widerrufsbelehrung', 'F&uuml;gen Sie hier Ihre Liefer- und Versandbedingungen ein' )") OR die ("<b>".NOTUPDATED . $prefix_table . "information_description</b>");
...
$result = $db->Execute("INSERT INTO " . $prefix_table . "information_description (information_id, information_languages_id, information_name, information_heading_title, information_description) VALUES (4, 1, 'Datenschutz', 'Datenschutzbelehrung', 'F&uuml;gen Sie hier Ihre Informationen zur Privatsph&auml;re und Datenschutz ein' )") OR die ("<b>".NOTUPDATED . $prefix_table . "information_description</b>");
...
$result = $db->Execute("INSERT INTO " . $prefix_table . "information_description (information_id, information_languages_id, information_name, information_heading_title, information_description) VALUES (5, 1, 'Liefer- und Versandbedingungen', 'Liefer- und Versandbedingungen', 'F&uuml;gen Sie hier Ihre Liefer- und Versandbedingungen ein' )") OR die ("<b>".NOTUPDATED . $prefix_table . "information_description</b>");
...
$result = $db->Execute("INSERT INTO " . $prefix_table . "tax_class (tax_class_id, tax_class_title, tax_class_description, last_modified, date_added) VALUES (1, 'Standard Steuersatz', 'normaler Steuersatz f&uuml;r Dienstleistungen und alle non-food Artikel', NULL, " . $db->DBTimeStamp($today) . ")") OR die ("<b>".NOTUPDATED . $prefix_table . "tax_class</b>");
$result = $db->Execute("INSERT INTO " . $prefix_table . "tax_class (tax_class_id, tax_class_title, tax_class_description, last_modified, date_added) VALUES (2, 'Ermäßigter Steuersatz', 'verminderter Steuersatz f&uuml;r Lebensmittel und B&uuml;cher', NULL, " . $db->DBTimeStamp($today) . ")") OR die ("<b>".NOTUPDATED . $prefix_table . "tax_class</b>");
