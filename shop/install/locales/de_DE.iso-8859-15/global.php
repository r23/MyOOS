...
define('CHMOD_CHECK_2', 'Es wird &uuml;berpr&uuml;ft, ob die Schreibrechte (CHMOD) von configure.php und configure-old.php korrekt gesetzt sind, ansonsten wird dieses Skript nicht in der Lage sein, die Datenbank-Informationen zu verschl&uuml;sseln. Die Verschl&uuml;sselung der Datenbank-Informationen ist eine zus&auml;tzliche Sicherheit.');
...
define('CHMOD_CHECK_8', 'Bitte &auml;ndern Sie die Zugriffsrechte (CHMOD 666) der Datei ~/includes/configure-old.php ');
