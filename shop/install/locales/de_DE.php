...
define('PHP_CHECK_15', 'F&uuml;r die Grafik-Funktionen im MyOOS [Shopsystem] empfehlen wir Ihnen die <br />GD-Bibliothek gd-lib Version 2.0 oder h&ouml;her - <a href=\'http://www.boutell.com/gd/\' target=\'_blank\'>http://www.boutell.com/gd/</a>');
...
define('OOSUPGRADE_5', 'Ihre MyOOS [Shopsystem] Version k&ouml;nnen Sie in der Datei <samp>~/shop/includes/oos_version.php</samp> ersehen.');
...
define('SHOW_ERROR_INFO', 'Fehler:</b> MyOOS [Shopsystem] Installation konnte nicht in die \'configure.php\' Datei  schreiben. <br /> Sie k&ouml;nnen mit einem EditOR diese Datei selbst &auml;ndern. <br />Hier die Informationen  die Sie eintragen sollten:');

define('VIRTUAL_1', 'Web Server');
define('VIRTUAL_2', 'Legen Sie nun die WebServer Umgebung f&uuml;r MyOOS [Shopsystem] fest.');
...
define('HTACCESS_ERROR', 'Um die Webserverkonfiguration zu testen ben&ouml;tigt MyOOS [Shopsystem] die M&ouml;glichkeit, die Datei ".htaccess" zu erstellen. Dies war aufgrund von Rechteproblemen nicht m&ouml;glich. Bitte passen Sie die Rechte wie folgt an: <br />&nbsp;&nbsp;%s<br />und laden Sie diese Seite neu.');

define('TMP_VIRTUAL_1', 'Session Einstellungen');
define('TMP_VIRTUAL_2', 'Die Unterst&uuml;tzung von Sessions im MyOOS [Shopsystem] bietet die M&ouml;glichkeit, bestimmte Daten w&auml;hrend einer Folge von Aufrufen Ihres Shop\'s festzuhalten. Sie k&ouml;nnen zwischen der standardm&auml;&szlig;igen files Prozedur und der Speicherung der Session-Daten in Ihre Datenbank w&auml;hlen. Bei der Speicherung in Ihre Datenbank k&ouml;nnen Sie zus&auml;tzlich noch festlegen, ob die Daten verschl&uuml;sselt in diese geschrieben werden sollen.');
...
define('CONTINUE_2', 'Legen Sie nun den Administrator-Account f&uuml;r MyOOS [Shopsystem] fest. Sie k&ouml;nnen sp&auml;ter mit der Email - Adresse und dem Passwort Ihren MyOOS [Shopsystem] konfigurieren.');
...
define('INPUT_DATA', 'Daten f&uuml;r MyOOS [Shopsystem] ');

define('FINISH_1', 'Danksagung');
define('FINISH_2', 'Bei dieser Gelegenheit m&ouml;chten wir allen danken, die zur Entwicklung von MyOOS [Shopsystem] beigetragen haben. Unser spezieller Dank geb&uuml;hrt den Entwicklern  von PHP. ');
define('FINISH_3', 'Sie haben MyOOS [Shopsystem] erfolgreich installiert. Bitte l&ouml;schen Sie nun das Installations Verzeichnis');
...
define('FOOTER', 'Diese WebSite wurde mit <a target="_blank" href="http://www.oos-shop.de/">MyOOS [Shopsystem]</a> erstellt. <br /><a target="_blank" href="http://www.oos-shop.de/">MyOOS [Shopsystem]</a> ist als freie Software unter der <a target="_blank" href="http://www.gnu.org/">GNU/GPL Lizenz</a> erh&auml;tlich.');
