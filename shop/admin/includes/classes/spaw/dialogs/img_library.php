...
//                                www.solmetra.com
// ================================================
// $Revision: 1.1 $, $Date: 2007/06/08 14:32:52 $
// ================================================
...
if (isset($HTTP_POST_FILES['img_file']['size']) && $HTTP_POST_FILES['img_file']['size']>0)
{
  ...
  {
    $preview = OOS_HTTP_SERVER.$imglib.$img;
  }
}
// delete
...
<head>
  ...
  <!--
    function selectClick()
    {
      ...
      {
        window.returnValue = '<?php echo OOS_HTTP_SERVER?>'+document.getElementById('lib').options[document.getElementById('lib').selectedIndex].value + document.getElementById('imglist').options[document.getElementById('imglist').selectedIndex].value;
        window.close();
        <?php
...
<tr>
  ...
  <select name="imglist" id="imglist" size="15" class="input" style="width: 150px;" 
    onchange="if (this.selectedIndex &gt;=0) document.getElementById('imgpreview').src = '<?php echo OOS_HTTP_SERVER.$imglib?>' + this.options[this.selectedIndex].value;" ondblclick="selectClick();"> 
  <?php 
