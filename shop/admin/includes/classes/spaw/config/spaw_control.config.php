...
if (!defined('OOS_SHOP')) {
  ...
  $self = dirname ($self);
  $self = str_replace('/classes/spaw/dialogs','/configure.php',$self);
...
$spaw_dir = OOS_SHOP . 'admin/' . OOS_WYSIWYG;

// base url for images
$spaw_base_url = OOS_HTTP_SERVER . OOS_SHOP . 'admin/' . OOS_WYSIWYG;

$spaw_root = OOS_ABSOLUTE_PATH . 'admin/' . OOS_WYSIWYG;
...
$spaw_imglibs = array(
  array(
    'value'   => OOS_SHOP_IMAGES,
    'text'    => 'Products - Subimages',
  ),
  array(
    'value'   => OOS_SHOP_IMAGES . OOS_POPUP_IMAGES,
    'text'    => 'Subimages Popup',
  ),
);
