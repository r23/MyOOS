...
define('STORE_OWNER_TITLE', 'Имя Владельца Магазина');
...
define('WEB_SEARCH_GOOGLE_KEY_TITLE', 'Google API Ключ');
...
define('ENTRY_FIRST_NAME_MIN_LENGTH_DESC', 'Минимальная длина значения поля Имя');

define('ENTRY_LAST_NAME_MIN_LENGTH_TITLE', 'Фамилия');
define('ENTRY_LAST_NAME_MIN_LENGTH_DESC', 'Минимальная длина значения поля Фамилия');

define('ENTRY_DOB_MIN_LENGTH_TITLE', 'Дата Рождения');
define('ENTRY_DOB_MIN_LENGTH_DESC', 'Минимальная длина значения поля Дата Рождения');

define('ENTRY_EMAIL_ADDRESS_MIN_LENGTH_TITLE', 'E-Mail Адрес');
define('ENTRY_EMAIL_ADDRESS_MIN_LENGTH_DESC', 'Минимальная длина значения поля E-Mail Адрес');

define('ENTRY_STREET_ADDRESS_MIN_LENGTH_TITLE', 'Адрес');
define('ENTRY_STREET_ADDRESS_MIN_LENGTH_DESC', 'Минимальная значения поля длина Адрес');

define('ENTRY_COMPANY_LENGTH_TITLE', 'Название Компании');
define('ENTRY_COMPANY_LENGTH_DESC', 'Минимальная длина значения поля Название Компании');

define('ENTRY_POSTCODE_MIN_LENGTH_TITLE', 'Индекс');
define('ENTRY_POSTCODE_MIN_LENGTH_DESC', 'Минимальная длина значения поля Индекс');

define('ENTRY_CITY_MIN_LENGTH_TITLE', 'Город');
define('ENTRY_CITY_MIN_LENGTH_DESC', 'Минимальная длина значения поля Город');

define('ENTRY_STATE_MIN_LENGTH_TITLE', 'Регион');
define('ENTRY_STATE_MIN_LENGTH_DESC', 'Минимальная длина значения поля Регион');

define('ENTRY_TELEPHONE_MIN_LENGTH_TITLE', 'Телефон');
define('ENTRY_TELEPHONE_MIN_LENGTH_DESC', 'Минимальная длина значения поля Телефон');

define('ENTRY_PASSWORD_MIN_LENGTH_TITLE', 'Пароль');
define('ENTRY_PASSWORD_MIN_LENGTH_DESC', 'Минимальная длина значения поля Пароль');

define('CC_OWNER_MIN_LENGTH_TITLE', 'Владелец Кредитной Карты');
define('CC_OWNER_MIN_LENGTH_DESC', 'Минимальная длина значения поля Владелец Кредитной Карты');

define('CC_NUMBER_MIN_LENGTH_TITLE', 'Номер Кредитной Карты');
define('CC_NUMBER_MIN_LENGTH_DESC', 'Минимальная длина значения поля Номер Кредитной Карты');
...
define('STORE_ORIGIN_COUNTRY_TITLE', 'Код Страны');
...
define('STORE_ORIGIN_ZIP_TITLE', 'Индекс');
...
define('PRODUCT_LIST_IMAGE_TITLE', 'Отображать Фотографию Товара');
define('PRODUCT_LIST_IMAGE_DESC', 'Do you want to display the Product Image?');

define('PRODUCT_LIST_MANUFACTURER_TITLE', 'Отображать Название Производителя');
define('PRODUCT_LIST_MANUFACTURER_DESC', 'Do you want to display the Product Manufacturer Name?');

define('PRODUCT_LIST_MODEL_TITLE', 'Отображать Артикул Товара');
define('PRODUCT_LIST_MODEL_DESC', 'Do you want to display the Product Model?');

define('PRODUCT_LIST_NAME_TITLE', 'Отображать Название Товара');
...
define('PRODUCT_LIST_PRICE_TITLE', 'Отображать Цену Товара');
define('PRODUCT_LIST_PRICE_DESC', 'Do you want to display the Product Price?');

define('PRODUCT_LIST_QUANTITY_TITLE', 'Отображать Количество Товара');
define('PRODUCT_LIST_QUANTITY_DESC', 'Do you want to display the Product Quantity?');

define('PRODUCT_LIST_WEIGHT_TITLE', 'Отображать Вес Товара');
define('PRODUCT_LIST_WEIGHT_DESC', 'Do you want to display the Product Weight?');

define('PRODUCT_LIST_BUY_NOW_TITLE', 'Отображать Кнопку Заказа');
define('PRODUCT_LIST_BUY_NOW_DESC', 'Do you want to display the Buy Now column?');

define('PRODUCT_LIST_FILTER_TITLE', 'Отображать Фильтр по Категории/Производителю (0=выключен; 1=включен)');
define('PRODUCT_LIST_FILTER_DESC', 'Do you want to display the Category/Manufacturer Filter?');

define('PRODUCT_LIST_SORT_ORDER_TITLE', 'Отображать Порядок Сортировки');
define('PRODUCT_LIST_SORT_ORDER_DESC', 'Do you want to display the Product Sort Order column?');

define('PREV_NEXT_BAR_LOCATION_TITLE', 'Расположение Постраничной Навигации (1-наверху, 2-внизу, 3-наверху и внизу)');
...
define('USE_CACHE_TITLE', 'Использовать Кеширование');
define('USE_CACHE_DESC', 'Use caching features');

define('DOWNLOAD_ENABLED_TITLE', 'Разрешить Скачивание');
...
define('BLOCK_XSELL_PRODUCTS_IMAGE_TITLE', 'Bild im Block дhnliche Produkte');
define('BLOCK_XSELL_PRODUCTS_IMAGE_DESC', 'Bild im Content-Block дhnliche Produkte anzeigen?');
...
define('MULTIPLE_CATEGORIES_USE_TITLE', 'Использовать Множественные Категории');
define('MULTIPLE_CATEGORIES_USE_DESC', 'Set to true or false in order to add product to multiple categories with one click.');

define('OOS_SPAW_TITLE', 'SPAW PHP Визуальный Редактор');
...
define('RCS_SHOW_ATTRIBUTES_TITLE', 'Отображать Опции');
