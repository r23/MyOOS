<?php
/* ----------------------------------------------------------------------
   $Id: information.php,v 1.1 2007/06/13 17:03:54 r23 Exp $
...
define('HEADING_TITLE', 'пїЅпїЅпїЅпїЅпїЅ');

define('TABLE_HEADING_INFORMATION', 'пїЅпїЅпїЅпїЅпїЅ');
...
define('TEXT_INFORMATION_IMAGE', 'Informationbild:');
define('TEXT_INFORMATION_URL', 'Information URL:');
