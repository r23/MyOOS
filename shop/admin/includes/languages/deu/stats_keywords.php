...
define('KEYWORD_TITLE2', 'Suchz&auml;hler');

define('SIDEBAR_HEADING', 'Suchwortoptionen');
define('SIDEBAR_INFO_1', 'Benutzen Sie den Schalter unterhalb um ALLE neuen Daten in der Datenbank zu dieser Seite hinzuzuf&uuml;gen.');
define('SIDEBAR_INFO_2', 'Um <b>ALLE</b> Suchworte aus der Datanebank zu l&ouml;schen, klicken Sie auf den unteren Schalter');
define('SIDEBAR_INFO_3', '<b>Ersetzen von Suchw&ouml;rtern und Begriffen</b><br /><br />Klicken Sie hier um falsche Suchw&ouml;rter anzuzeigen oder zu editieren:');
...
define('BUTTON_ADD_WORD', 'Wort zur Tabelle hinzuf&uml;gen');
