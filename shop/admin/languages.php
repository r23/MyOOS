<?php
/* ----------------------------------------------------------------------
   $Id: languages.php 436 2013-06-22 14:39:19Z r23 $
  ...
  if (!empty($action)) {
    switch ($action) {
      ...
      case 'insert':
        ...
        $products_result = $dbconn->Execute("SELECT p.products_id, pd.products_name, pd.products_description, pd.products_short_description, pd.products_url 
