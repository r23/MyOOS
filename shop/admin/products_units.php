...
<?php
  ...
  switch ($action) {
    case 'new':
      ...
      $contents = array('form' => oos_draw_form('status', $aContents['products_units'], 'page=' . $_GET['page'] . '&action=insert', 'post', FALSE));
    ...
    case 'edit':
      ...
      $contents = array('form' => oos_draw_form('status', $aContents['products_units'], 'page=' . $_GET['page'] . '&uID=' . $oInfo->products_units_id  . '&action=save', 'post',  FALSE));
    ...
    case 'delete':
      ...
      $contents = array('form' => oos_draw_form('status', $aContents['products_units'], 'page=' . $_GET['page'] . '&uID=' . $oInfo->products_units_id  . '&action=deleteconfirm', 'post',  FALSE));
