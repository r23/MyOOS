<?php
/* ----------------------------------------------------------------------
   $Id: packingslip.php 437 2013-06-22 15:33:30Z r23 $
...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
    <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td class="pageHeading"><?php echo nl2br(STORE_NAME . '<br />' . STORE_ADDRESS_STREET. '<br />' .  STORE_ADDRESS_POSTCODE . ' ' . STORE_ADDRESS_CITY); ?></td>
