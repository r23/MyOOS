<?php
/* ----------------------------------------------------------------------
   $Id: stats_sales_report2.php 437 2013-06-22 15:33:30Z r23 $
...
?>
                    ...
                    <td class="dataTableContent" align="left"><a href="<?php echo oos_catalog_link($aCatalogFilename['product_info'], 'products_id=' . $info[$i]['pid']) ?>" target="_blank"><?php echo $info[$i]['pname']; ?></a>
<?php
