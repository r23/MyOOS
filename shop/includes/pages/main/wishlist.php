<?php
/* ----------------------------------------------------------------------
   $Id: wishlist.php,v 1.1 2007/06/07 16:50:51 r23 Exp $
  ...
  include_once MYOOS_INCLUDE_PATH . '/includes/languages/' . $sLanguage . '/main_wishlist.php';
  ...
  // links breadcrumb
  $oBreadcrumb->add($customer. $aLang['navbar_title'], oos_href_link($aModules['account'], $aFilename['main_wishlist']));
