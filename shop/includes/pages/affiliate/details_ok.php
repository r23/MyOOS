<?php
/* ----------------------------------------------------------------------
   $Id: details_ok.php,v 1.1 2007/06/07 16:29:21 r23 Exp $
   ...
   File: affiliate_details_ok.php,v 1.5 2003/02/17 22:13:29 harley_vb
   ----------------------------------------------------------------------
   OSC-Affiliate
  ...
  require 'includes/languages/' . $sLanguage . '/affiliate_details_ok.php';

  // links breadcrumb
  $oBreadcrumb->add($aLang['navbar_title'], oos_href_link($aModules['affiliate'], $aFilename['affiliate_details_ok']));
