<?php
/* ----------------------------------------------------------------------
   $Id: help2.php,v 1.1 2007/06/07 16:29:21 r23 Exp $
   ...
   File: affiliate_help2.php,v 1.4 2003/02/17 17:21:19 harley_vb
   ----------------------------------------------------------------------
   OSC-Affiliate
  ...
  $help_cache_id = $sTheme . '|help|2|' . $sLanguage;
  ...
  if (!$oSmarty->is_cached($aOption['popup_help'], $help_cache_id )) {
    ...
    $oSmarty->assign('affiliate_help_text', $aLang['text_visits_help']);
