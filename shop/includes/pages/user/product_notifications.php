<?php
/* ----------------------------------------------------------------------
   $Id: product_notifications.php,v 1.1 2007/06/07 17:11:51 r23 Exp $
...
if ( is_session_started() === FALSE ) oos_session_start();  
  ...
  include_once MYOOS_INCLUDE_PATH . '/includes/languages/' . $sLanguage . '/user_product_notifications.php';
