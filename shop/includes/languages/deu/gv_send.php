...
Wert angeben, den Sie verschenken m&ouml;chten, auf <b><tt>weiter</tt></b> dr&uuml;cken, und los gehts. Weitere Informationen &uuml;ber die Gutschein-Funktionen finden Sie in den <a href="' . oos_href_link($aModules['gv'], $aFilename['gv_faq']).'">Gutschein FAQ\'s</a><br />';
