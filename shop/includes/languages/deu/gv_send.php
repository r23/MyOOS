...
Wert angeben, den Sie verschenken möchten, auf <b><tt>weiter</tt></b> drücken, und los gehts. Weitere Informationen über die Gutschein-Funktionen finden Sie in den <a href="' . oos_href_link($aContents['gv_faq']).'">Gutschein FAQ\'s</a><br />';
