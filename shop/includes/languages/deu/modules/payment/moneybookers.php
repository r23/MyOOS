<?php
/* ----------------------------------------------------------------------
   $Id: moneybookers.php,v 1.5 2008/10/03 15:38:16 r23 Exp $
...
define('MODULE_PAYMENT_MONEYBOOKERS_ID_TITLE', 'eMail Adresse');
define('MODULE_PAYMENT_MONEYBOOKERS_ID_DESC', 'eMail Adresse, die bei Moneybookers.com registriert ist');
...
define('MODULE_PAYMENT_MONEYBOOKERS_CURRENCY_DESC', 'Die W&auml;hrung, die f&uuml;r Moneybookers verwendet wird');

define('MODULE_PAYMENT_MONEYBOOKERS_LANGUAGE_TITLE', 'Transaktionssprache');
define('MODULE_PAYMENT_MONEYBOOKERS_LANGUAGE_DESC', 'Die Sprache f&uuml;r die Zahlungstransaktion.');
