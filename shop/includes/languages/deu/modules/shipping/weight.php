...
define('MODULE_SHIPPING_WEIGHT_TAX_CLASS_DESC', 'Wählen Sie den MwSt.-Satz f&uuml;r diese Versandart aus.');
...
define('MODULE_SHIPPING_WEIGHT_STEP_DESC', 'Erhöhungsschritt pro &uuml;bersteigendes kg in EUR');
