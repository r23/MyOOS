<?php
/* ----------------------------------------------------------------------
   $Id: chp.php,v 1.1 2007/06/13 15:54:26 r23 Exp $
   ...
   File: chp.php,v 1.01 2003/02/18 03:30:00 harley_vb 
   ----------------------------------------------------------------------
...
define('MODULE_SHIPPING_CHP_TAX_CLASS_DESC', 'Wï¿½len Sie den MwSt.-Satz fr diese Versandart aus.');

define('MODULE_SHIPPING_CHP_ZONE_TITLE', 'Versand Zone');
define('MODULE_SHIPPING_CHP_ZONE_DESC', 'Wenn Sie eine Zone auswï¿½len, wird diese Versandart nur in dieser Zone angeboten.');
...
define('MODULE_SHIPPING_CHP_COUNTRIES_1_TITLE', 'Tarifzone 0 Lï¿½der');
...
define('MODULE_SHIPPING_CHP_COUNTRIES_2_TITLE', 'Tarifzone 1 Lï¿½der');
define('MODULE_SHIPPING_CHP_COUNTRIES_2_DESC', 'Durch Komma getrennt Liste der Lï¿½der als zwei Zeichen ISO-Code Landeskennzahlen, die Teil der Zone 1 sind.');
...
define('MODULE_SHIPPING_CHP_COUNTRIES_3_TITLE', 'Tarifzone 2 Lï¿½der');
define('MODULE_SHIPPING_CHP_COUNTRIES_3_DESC', 'Durch Komma getrennt Liste der Lï¿½der als zwei Zeichen ISO-Code Landeskennzahlen, die Teil der Zone 2 sind.');
...
define('MODULE_SHIPPING_CHP_COUNTRIES_4_TITLE', 'Tarifzone 3 Lï¿½der');
define('MODULE_SHIPPING_CHP_COUNTRIES_4_DESC', 'Durch Komma getrennt Liste der Lï¿½der als zwei Zeichen ISO-Code Landeskennzahlen, die Teil der Zone 3 sind.');
...
define('MODULE_SHIPPING_CHP_COUNTRIES_5_TITLE', 'Tarifzone 4 Lï¿½der');
define('MODULE_SHIPPING_CHP_COUNTRIES_5_DESC', 'Durch Komma getrennt Liste der Lï¿½der als zwei Zeichen ISO-Code Landeskennzahlen, die Teil der Zone 4 sind.');
...
define('MODULE_SHIPPING_CHP_COUNTRIES_6_TITLE', 'Tarifzone 5 Lï¿½der');
define('MODULE_SHIPPING_CHP_COUNTRIES_6_DESC', 'Durch Komma getrennt Liste der Lï¿½der als zwei Zeichen ISO-Code Landeskennzahlen, die Teil der Zone 5 sind.');
...
define('MODULE_SHIPPING_CHP_COUNTRIES_7_TITLE', 'Tarifzone 6 Lï¿½der');
define('MODULE_SHIPPING_CHP_COUNTRIES_7_DESC', 'Durch Komma getrennt Liste der Lï¿½der als zwei Zeichen ISO-Code Landeskennzahlen, die Teil der Zone 6 sind.');
...
$aLang['module_shipping_chp_text_title'] = 'El Poste Suizo';
$aLang['module_shipping_chp_text_description'] = 'El Poste Suizo';
$aLang['module_shipping_chp_text_way'] = 'Envï¿½';
$aLang['module_shipping_chp_text_units'] = 'kg';
$aLang['module_shipping_chp_invalid_zone'] = 'Desafortunadamente no es posible enviar en este paï¿½';
$aLang['module_shipping_chp_undefined_rate'] = 'Los costos de expediciï¿½ no se pueden calcular para el momento';
?>
