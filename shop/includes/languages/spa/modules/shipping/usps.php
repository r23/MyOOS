<?php
/* ----------------------------------------------------------------------
   $Id: usps.php,v 1.1 2007/06/13 15:54:26 r23 Exp $
   ...
   File:usps.php,v 1.8 2003/02/14 12:54:38 dgw_ 
   ----------------------------------------------------------------------
...
$aLang['module_shipping_usps_text_error'] = 'Ha ocurrido un error calculando los gastos de envio.<br />Si aun desea usar USPS para su envio, contacte con el administrador.';
?>
