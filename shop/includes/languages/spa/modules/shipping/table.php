<?php
/* ----------------------------------------------------------------------
   $Id: table.php,v 1.1 2007/06/13 15:54:26 r23 Exp $
   ...
   File: table.php,v 1.5 2002/11/19 01:14:34 dgw_ 
   ----------------------------------------------------------------------
...
$aLang['module_shipping_table_text_title'] = 'Tabla de Tarifas';
$aLang['module_shipping_table_text_description'] = 'Tabla de Tarifas';
$aLang['module_shipping_table_text_way'] = '';
$aLang['module_shipping_table_text_weight'] = 'Peso';
$aLang['module_shipping_table_text_amount'] = 'Total';
?>
