<?php
/* ----------------------------------------------------------------------
   $Id: dp.php,v 1.1 2007/06/13 15:54:26 r23 Exp $
   ...
   File: dp.php,v 1.4 2003/02/18 03:30:00 harley_vb
   ----------------------------------------------------------------------
...
$aLang['module_shipping_dp_text_way'] = 'Env�';
$aLang['module_shipping_dp_text_units'] = 'kg';
$aLang['module_shipping_dp_invalid_zone'] = 'Desafortunadamente no es posible enviar en este pa�';
$aLang['module_shipping_dp_undefined_rate'] = 'Los costos de expedici� no se pueden calcular para el momento';
?>
