<?php
/* ----------------------------------------------------------------------
   $Id: ot_gv.php,v 1.3 2007/08/04 04:52:50 r23 Exp $
...
$aLang['module_order_total_gv_title'] = 'Tegoedbon';
$aLang['module_order_total_gv_header'] = 'Tegoedbon';
$aLang['module_order_total_gv_description'] = 'Tegoedbon';
$aLang['shipping_not_included'] = ' [Verzendkosten niet inbegrepen]';
$aLang['tax_not_included'] = ' [B.T.W. niet inbegrepen]';
$aLang['module_order_total_gv_user_prompt'] = 'Wilt met een tegoedbon betalen? ->&nbsp;';
$aLang['text_enter_gv_code'] = 'Tegoedboncode&nbsp;&nbsp;';
?>
