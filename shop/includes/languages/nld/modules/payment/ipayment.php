<?php
/* ----------------------------------------------------------------------
   $Id: ipayment.php,v 1.3 2007/08/04 04:52:50 r23 Exp $
...
$aLang['module_payment_ipayment_text_description'] = 'Credietkaarttest info:<br /><br />CC#: 4111111111111111<br />Geldig tot: Altijd';
$aLang['ipayment_error_heading'] = 'Volgende fout werd door iPayment tijdens het proces gemeld:';
$aLang['ipayment_error_message'] = 'Controleer a.u.b. de gegevens van uw credietkaart!';
$aLang['module_payment_ipayment_text_credit_card_owner'] = 'Credietkaarthouder';
$aLang['module_payment_ipayment_text_credit_card_number'] = 'Credietkaartennr.:';
$aLang['module_payment_ipayment_text_credit_card_expires'] = 'Geldig tot:';
$aLang['module_payment_ipayment_text_credit_card_checknumber'] = 'Kaart-testfnummer:';
$aLang['module_payment_ipayment_text_credit_card_checknumber_location'] = '(Op de kaartachterkant in handtekeningsveld)';

$aLang['module_payment_ipayment_text_js_cc_owner'] = '* De naam van de credietkaarthouder moet minstens uit  ' . CC_OWNER_MIN_LENGTH . ' karakters bestaan.\n';
$aLang['module_payment_ipayment_text_js_cc_number'] = '* Het \'credietkaartnr.\' moet minstens uit ' . CC_NUMBER_MIN_LENGTH . ' cijfers bestaan.\n';
?>
