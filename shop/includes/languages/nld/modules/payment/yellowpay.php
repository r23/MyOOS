...
define('MODULE_PAYMENT_YELLOWPAY_STATUS_TITLE', 'Enable PostFinance Module');
...
$aLang['module_payment_paypal_text_title'] = 'PostFinance';
$aLang['module_payment_paypal_text_description'] = 'PostFinance';
?>