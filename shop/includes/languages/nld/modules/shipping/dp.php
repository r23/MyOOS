<?php
/* ----------------------------------------------------------------------
   $Id: dp.php,v 1.3 2007/08/04 04:52:51 r23 Exp $
...
$aLang['module_shipping_dp_text_description'] = 'DHL - Wereldwijde verzendeing';
$aLang['module_shipping_dp_text_way'] = 'Verzenden naar';
$aLang['module_shipping_dp_text_units'] = 'kg';
$aLang['module_shipping_dp_invalid_zone'] = 'Er is geen verzending naar dit land mogelijk!';
$aLang['module_shipping_dp_undefined_rate'] = 'De verzendkosten kunnen op dit moment niet berekend worden!';
?>
