...
$aLang['text_see_orders'] = 'You can view your order history by going to the <a href="' . oos_href_link($aModules['user'], $aFilename['account'], '', 'SSL') . '">\'My Account\'</a> page and by clicking on <a href="' . oos_href_link($aModules['account'], $aFilename['account_history'], '', 'SSL') . '">\'History\'</a>.';
$aLang['text_contact_store_owner'] = 'Please direct any questions you have to the <a href="' . oos_href_link($aModules['main'], $aFilename['contact_us']) . '">store owner</a>.';
