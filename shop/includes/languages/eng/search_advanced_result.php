...
$aLang['text_no_products'] = '<br /><span style="font-size:11px;">Your search - <strong>' . stripslashes($_GET['keywords']) . '</strong> - did not match any products.</span><br /><br />Some Suggestions:<ol><li>Check that your spelling was accurate.</li><li>Try using different keywords</li><li>Try using fewer keywords</li><li>Try using more general keywords</li></ol>';
$aLang['text_no_products2'] = '<br /><span style="font-size:11px;">Your search - <strong>' . stripslashes($_GET['keywords']) . '</strong> - did not match any products.</span><br /><br />Some Suggestions:<ol><li>Check that your spelling was accurate.</li><li>Try using different keywords</li><li>Try using fewer keywords</li></ol>';
