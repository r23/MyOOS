<?php
/* ----------------------------------------------------------------------
   $Id: cc.php,v 1.3 2007/08/04 04:51:11 r23 Exp $
...
$aLang['module_payment_cc_text_title'] = 'Кредитная карта';
$aLang['module_payment_cc_text_description'] = 'Credit Card Test Info:<br><br>CC#: 4111111111111111<br>Expiry: Any';
$aLang['module_payment_cc_text_credit_card_type'] = 'Тип Кредитной карты:';
$aLang['module_payment_cc_text_credit_card_owner'] = 'Владелец Кредитной карты:';
$aLang['module_payment_cc_text_credit_card_number'] = 'Номер Кредитной карты:';
$aLang['module_payment_cc_text_credit_card_expires'] = 'Кредитная карта действительна до:';
$aLang['module_payment_cc_text_js_cc_owner'] = '* Имя владельца должно содержать не менее ' . CC_OWNER_MIN_LENGTH . ' знаков.\n';
$aLang['module_payment_cc_text_js_cc_number'] = '* Номер кредитной карты должен содержать ' . CC_NUMBER_MIN_LENGTH . ' знаков.\n';
$aLang['module_payment_cc_text_error'] = 'Данные введены неправильно!';
