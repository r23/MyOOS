<?php
/* ----------------------------------------------------------------------
   $Id: secpay.php,v 1.3 2007/08/04 04:51:11 r23 Exp $
...
$aLang['module_payment_secpay_text_description'] = 'Информация о кредитной карточке для теста:<br><br>CC#: 4444333322221111<br>Действительна до: любое';
$aLang['module_payment_secpay_text_error'] = 'Ошибка!';
$aLang['module_payment_secpay_text_error_message'] = 'Имеется ошибка при обработке Вашей кредитной карточки, пожалуйста попытайтесь снова.';
