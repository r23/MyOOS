<?php
/* ----------------------------------------------------------------------
   $Id: user_create_account_success.php,v 1.3 2007/06/12 17:25:13 r23 Exp $
...
$aLang['text_main'] = 'Congratulations! Your new account has been successfully created! You can now take advantage of member priviledges to enhance your online shopping experience with us. If you have <small><b>ANY</b></small> questions about the operation of this online shop, please email the <a href="' . oos_href_link($aModules['main'], $aFilename['contact_us']) . '">store owner</a>.<br /><br />A confirmation has been sent to the provided email address. If you have not received it within the hour, please <a href="' . oos_href_link($aModules['main'], $aFilename['contact_us']) . '">contact us</a>.';
