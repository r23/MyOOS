...
define('PLUGIN_EVENT_AFFILIATE_NAME', 'Partnerprogramms');
define('PLUGIN_EVENT_AFFILIATE_DESC', 'Um ein Partnerprogramm anzubeiten.');
define('AFFILIATE_OWNER_TITLE', 'Affilate Owner');
define('AFFILIATE_OWNER_DESC', 'The Adminname of my Affiliate Programm');
