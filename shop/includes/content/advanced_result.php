<?php
/* ----------------------------------------------------------------------
   $Id: advanced_result.php,v 1.1 2007/06/07 17:11:51 r23 Exp $
  ...
  if (isset($_GET['keywords']) && $_GET['keywords'] != '') {
    if (!isset($_GET['s'])){
      ...
      if ($pwstr_check == 's') {
        ...
        oos_redirect(oos_href_link($aContents['advanced_search_result'], 'search_in_description=1&s=1&keywords=' . urlencode($pwstr_replace) . '' ));
      }
    }
    ...
    $pw_string      = '<br /><span class="main"><font color="red">' . $aLang['text_replacement_suggestion'] . '</font><a href="' . oos_href_link($aContents['advanced_search_result'] , 'keywords=' . urlencode($pw_replacement) . '&search_in_description=1' ) . '">' . $pw_link_text . '</a></span><br /><br />';
  }
