<?php
/* ----------------------------------------------------------------------
   $Id: class_maps.php,v 1.2 2009/02/17 03:49:20 r23 Exp $
...
class SPAF_Maps {
  ...
  var $geonames_url = 'http://ws5.geonames.org/search?q={query}&maxRows={rows}&style=LONG';
  var $query = '';
  var $country = '';
  var $results = '';
  var $default = '';
  ...
  */
  ...
  function getHeaderJS() {
     return sprintf('<script src="http://maps.google.com/maps?file=api&v=2&key=%s" type="text/javascript" charset="utf-8"></script>', $this->google_api_key);
  }
