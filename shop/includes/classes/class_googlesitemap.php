<?php
/* ----------------------------------------------------------------------
   $Id: class_googlesitemap.php 296 2013-04-13 14:48:55Z r23 $
   ...
   */
   ...
   class GoogleSitemap{
    ...
    /**
     * Function to retrieve full category from category ID
     *
     * @param mixed $cID Could contain category or single category_id
     * @return string Full category string
     */
     function GetFullcategory($cID){
       if ( preg_match('/_/', $cID) ){
         return $cID;
       } else {
         $c = array();
