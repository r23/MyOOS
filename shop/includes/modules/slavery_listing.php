        ...
        for ($col=0, $n=count($column_list); $col<$n; $col++) {
          ...
          switch ($column_list[$col]) {
            ...
            if ($aUser['show_price'] == 1) {
               ...
               $lc_text = '<a href="' . oos_href_link($sContent, $all_get_listing . 'action=buy_slave&amp;slave_id=' . $listing['products_id'] . '&amp;cart_quantity=' . $order_min ) . '" class="btn btn-primary-filled" role="button"><i class="fa fa-shopping-cart"></i> ' . $aLang['text_now'] . '</a>&nbsp;';
