...
// class methods
    ...
    function process_button() {
      ...
      $process_button_string = oos_draw_hidden_field('cmd', '_xclick') .
                               ...
                               oos_draw_hidden_field('returnurl', oos_href_link($aContents['checkout_process'], '', 'SSL')) .
                               oos_draw_hidden_field('cancel_return', oos_href_link($aContents['checkout_payment'], '', 'SSL'));
