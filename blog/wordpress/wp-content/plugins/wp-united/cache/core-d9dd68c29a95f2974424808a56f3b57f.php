 ...
 * @seit 2.6.0
 */
define('AUTH_KEY',         'P-I]`|]HL(T+V@RB-knKf Vy]T(^M%0t.IHScsMwi<1c,yy]<:0mJ1!l_UeeaKMj');
define('SECURE_AUTH_KEY',  '_Xd{l^XIQnb9+L@Y[r; Oj<UO$KSmSYmNlY&*zg]rzwjp[ v~9zlfO8zi`p{q|Ah');
define('LOGGED_IN_KEY',    'DB4QOdQLlZ[a52RGz;*8/1_GQ7s@@${I^kJ{GrY4n=P$|w:mdIO{WAHjbF>+kRtP');
define('NONCE_KEY',        '3uFYMHh~d&BU;YpInJ W@1W5}FNy,fbG`yI<wf4FJk|&D<}5+2zs.M#o6Rf,o)=@');
define('AUTH_SALT',        ']2Amz6CyX65DsVR0V>#:vRDq5sy]nubg-(_Z-Mf-}5Zy`pFw}PQ7]l@R++v8stk*');
define('SECURE_AUTH_SALT', 'TpX>,N37K5y#<|y1iQmoY% JdW6~<d579jan}C=o`d<)of[Fa&o+5J46vUBw]PH1');
define('LOGGED_IN_SALT',   'Y6Nx#3q^>Oo]B5]n14^P|*X)HTxHxa]F6FG#D/FLeg9[p$I0nJ~OY6w_YQtH71ut');
define('NONCE_SALT',       '+I wJXYUtWLv*k(HEU*cXUm{<E uao9c+`E0K`d?f1 M`P.4mHE>-`[.a%~vgvbM');
