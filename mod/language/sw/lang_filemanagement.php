...
$lang['L_MAX_UPLOAD_SIZE_INFO']="Om din backup-fil är större än det angivna värdet så måste du ladda upp den till mappen \"work/backup\" via FTP/SFTP. Därefter visas filen här i översikten och kan väljas för återställning.";
