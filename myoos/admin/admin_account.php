...
<?php
  ...
  switch ($action) {
    ...
    case 'check_account':
      ...
      $contents[] = array('align' => 'center', 'text' => '<a href="' . oos_href_link_admin($aContents['admin_account']) . '">' . oos_button('back', IMAGE_BACK) . '</a> ' . oos_submit_button(IMAGE_CONFIRM) . '<br />&nbsp');
      break;
