...
**/
        ...
        _bindFields: function () {
            ...
            this._withoutReactualizingFormOptions(
                function () {
                    ...
                    $(oldFields).not(self.fields).each(
                        function () {
                            this._trigger('reset');
                        }
                    );
    ...
    ConstraintFactory.prototype = {
        ...
        _parseRequirements: function (options) {
            ...
            this.requirementList = this.validator.parseRequirements(
                this.requirements, function (key) {
    ...
    ParsleyField.prototype = {
        ...
        whenValid: function (force, value) {
            ...
            var that = this;
            $.each(
                groupedConstraints, function (_, constraints) {
    ...
    ParsleyMultiple.prototype = {
        ...
        getValue: function () {
            ...
            if (this.$element.is('input[type=checkbox]')) {
                var values = [];
                this._findRelatedMultiple().filter(':checked').each(
                    function () {
    ...
    $.unsubscribeAll = function (name) {
        ...
        $('form,input,textarea,select').each(
            function () {
    ...
    $.each(
        'setLocale addCatalog addMessage getErrorMessage formatMessage addValidator updateValidator removeValidator'.split(' '), function (i, method) {
