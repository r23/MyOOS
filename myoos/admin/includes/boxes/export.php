...
$aBlocks[] = ['heading' => BOX_HEADING_EXPORT, 'link' => oos_href_link_admin(basename($php_self), oos_get_all_get_params(['selected_box']) . 'selected_box=tools'), 'icon' => 'fa fa-database', 'active' => $bActive, 'contents' => [['code' => $aContents['export_excel'], 'title' => BOX_CATALOG_EXPORT_EXCEL, 'link' => oos_admin_files_boxes('export_excel', 'selected_box=export')], ['code' => $aContents['import_excel'], 'title' => BOX_CATALOG_IMPORT_EXCEL, 'link' => oos_admin_files_boxes('import_excel', 'selected_box=catalog')]]];
