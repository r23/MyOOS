...
define('HEADING_TITLE', 'Lieferländer');

define('TABLE_HEADING_COUNTRY_NAME', 'Lieferland');
...
define('TEXT_INFO_INSERT_INTRO', 'Bitte geben Sie das neue Lieferland mit allen relevanten Daten ein');
define('TEXT_INFO_DELETE_INTRO', 'Sind Sie sicher, dass Sie das Lieferland löschen möchten?');
define('TEXT_INFO_HEADING_NEW_COUNTRY', 'neues Lieferland');
define('TEXT_INFO_HEADING_EDIT_COUNTRY', 'Lieferland bearbeiten');
define('TEXT_INFO_HEADING_DELETE_COUNTRY', 'Lieferland löschen');
