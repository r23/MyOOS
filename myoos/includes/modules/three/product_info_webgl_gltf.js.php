...
?>
		...
		<script type="module">
			...
			var scenes = {
				...
				'Bot Skinned': {
					name: 'Bot Skinned',
					url: './media/models/gltf/BotSkinned/%s/Bot_Skinned.gltf',
					author: 'MozillaVR',
				...
				MetalRoughSpheres: {
					...
					url: './media/models/gltf/MetalRoughSpheres/%s/MetalRoughSpheres.gltf',
					author: '@emackey',
				...
				Duck: {
					name: 'Duck',
					url: './media/models/gltf/Duck/%s/Duck.gltf',
					author: 'Sony',
				...
				Monster: {
					name: 'Monster',
					url: './media/models/gltf/Monster/%s/Monster.gltf',
					author: '3drt.com',
				...
				'Cesium Man': {
					name: 'Cesium Man',
					url: './media/models/gltf/CesiumMan/%s/CesiumMan.gltf',
					author: 'Cesium',
				...
				'Cesium Milk Truck': {
					...
					url: './media/models/gltf/CesiumMilkTruck/%s/CesiumMilkTruck.gltf',
					author: 'Cesium',
					authorURL: 'https://cesiumjs.org/',
					cameraPos: new THREE.Vector3( 0, 3, 10 ),
					addLights: true,
				...
				'Outlined Box': {
					name: 'Outlined Box',
					url: './media/models/gltf/OutlinedBox/OutlinedBox.gltf',
					author: '@twittmann',
