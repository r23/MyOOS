...
// class constructor
    public function __construct() {
      ...
      $this->icon = '';
      $this->tax_class = (defined('MODULE_SHIPPING_ITEM_PRICE_WITH_TAX') && (MODULE_SHIPPING_ITEM_PRICE_WITH_TAX == 'true') ? true : false);
...
// class methods
    ...
    function install() {
      ...
      $dbconn->Execute("INSERT INTO $configurationtable (configuration_key, configuration_value, configuration_group_id, sort_order, set_function, date_added) VALUES ('MODULE_SHIPPING_ITEM_PRICE_WITH_TAX',  'true', '6', '0', 'oos_cfg_select_option(array(\'true\', \'false\'), ', now())");
    ...
    function keys() {
      return array('MODULE_SHIPPING_ITEM_STATUS', 'MODULE_SHIPPING_ITEM_COST', 'MODULE_SHIPPING_ITEM_HANDLING', 'MODULE_SHIPPING_ITEM_PRICE_WITH_TAX', 'MODULE_SHIPPING_ITEM_ZONE', 'MODULE_SHIPPING_ITEM_SORT_ORDER');
    }
  }
