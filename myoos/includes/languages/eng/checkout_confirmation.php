...
$aLang['text_conditions'] = 'I have read the general <a href="%s" target="_blank" rel="noopener"><strong>Terms and Conditions</strong></a> of the provider and declare my agreement by sending the order.<br>
I have read and understood the <a href="%s" target="_blank" rel="noopener"><strong>Right of Recission / the Sample Revocation Form</strong></a>.<br>
I have read the provisions of the <a href="%s" target="_blank" rel="noopener"><strong>data protection declaration</strong></a> and agree with the provisions set out.';
