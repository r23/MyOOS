...
define('MODULE_SHIPPING_AP_HANDLING_TITLE', 'Handling Gebühr');
...
define('MODULE_SHIPPING_AP_ZONE_DESC', 'Geben Sie <strong>einzeln</strong> die Zonen an, in welche ein Versand möglich sein soll. (z.B. AT,DE (lassen Sie dieses Feld leer, wenn Sie alle Zonen erlauben wollen))');
...
define('MODULE_SHIPPING_AP_COST_1_DESC', 'Tarif Tabelle für die Zone 1a, basiered auf <strong>\'Schnelles Paket\'</strong> bis 20 kg Versandgewicht.');
...
define('MODULE_SHIPPING_AP_COST_2_DESC', 'Tarif Tabelle für die Zone 1b, basiered auf <strong>\'Schnelles Paket\'</strong> bis 20 kg Versandgewicht.');
...
define('MODULE_SHIPPING_AP_COST_3_DESC', 'Tarif Tabelle für die Zone 2, basiered auf <strong>\'Schnelles Paket\'</strong> bis 20 kg Versandgewicht.');
...
define('MODULE_SHIPPING_AP_COST_4_DESC', 'Tarif Tabelle für die Zone 3, basiered auf <strong>\'Schnelles Paket\'</strong> bis 20 kg Versandgewicht.');
...
define('MODULE_SHIPPING_AP_COST_5_DESC', 'Tarif Tabelle für die Zone 4, basiered auf <strong>\'Schnelles Paket\'</strong> bis 20 kg Versandgewicht.');
...
define('MODULE_SHIPPING_AP_COST_6_DESC', 'Tarif Tabelle für die Zone 4, basiered auf <strong>\'Schnelles Paket\'</strong> bis 20 kg Versandgewicht.');
...
define('MODULE_SHIPPING_AP_COST_7_DESC', 'Tarif Tabelle für die Zone 5, basiered auf <strong>\'Schnelles Paket\'</strong> bis 20 kg Versandgewicht.');
...
$aLang['module_shipping_ap_text_title'] = 'Österreichische Post AG';
$aLang['module_shipping_ap_text_description'] = 'Österreichische Post AG - Weltweites Versandmodul';
$aLang['module_shipping_ap_text_way'] = 'Versand nach';
$aLang['module_shipping_ap_text_units'] = 'kg';
$aLang['module_shipping_ap_invalid_zone'] = 'Es ist leider kein Versand in dieses Land möglich';
$aLang['module_shipping_ap_undefined_rate'] = 'Die Versandkosten können im Moment nicht errechnet werden';
