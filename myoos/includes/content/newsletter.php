...
if (isset($_GET['subscribe']) && ($_GET['subscribe'] == 'confirm')) {
    $sU = filter_string_polyfill(filter_input(INPUT_GET, 'u'));
    $sID = filter_string_polyfill(filter_input(INPUT_GET, 'id'));
    $sE = filter_string_polyfill(filter_input(INPUT_GET, 'e'));
