...
$products_models_sql = "SELECT m.models_id, m.products_id,  md.models_name, md.models_title, md.models_description_meta, 
								...
								m.models_object_rotation, m.models_object_scalar, m.models_add_lights, m.models_add_ground, m.models_shadows, m.models_add_env_map,
								m.models_extensions, m.models_hdr, models_hdr_name, models_hdr_url, models_hdr_author, models_hdr_author_url
