...
$w3all_conf_pref['w3all_link_roles_groups'] = (isset($w3all_conf_pref['w3all_link_roles_groups']) && ! empty($w3all_conf_pref['w3all_link_roles_groups'])) ? $w3all_conf_pref['w3all_link_roles_groups'] : 0;
...
<p><input type="radio" name="w3all_conf_pref[w3all_custom_output_files]" id="w3all_custom_output_files_0" value="0" <?php checked('0', $w3all_conf_pref['w3all_custom_output_files']); ?> /> <?php echo __('No, use default plugin files', 'wp-w3all-phpbb-integration'); ?></p>
<hr />
