...
# notification.type.forum ??
 ...
 global $w3all_url_to_cms;
     ...
     $notifi_lang_types_ary = array(
      ...
      'post_reorted'  => __('<b>Post reported:</b> ', 'wp-w3all-phpbb-integration'),
  ...
  if(!empty($w3all_phpbb_unotifications))
  {
    ...
    foreach( $w3all_phpbb_unotifications as $nnn )
    {
     ...
     foreach( $nnn as $nn => $n )
     {
       ...
       if( $nn == 'notification_type_name' && strpos($n,'type.topic') )
        {
        ...
        } elseif ( $nn == 'notification_type_name' && strpos($n,'type.approve_topic')
        ...
        {
         //echo 'notification.type.forum found!';
        }
