...
(0,f.__)("By %s"),n))))))):null}var he;const{PluginPrePublishPanel:fe}=null!==(he=window?.wp?.editPost)&&void 0!==he?he:{};function ve(){const e=(0,i.useSelect)((e=>e(G).getNewBlockTypes()),[]);return e.length?(0,r.createElement)(fe,{icon:ke,title:(0,f.sprintf)(// translators: %d: number of blocks (number).
...
(0,f.__)("Install %s"),t.title))}const Ie=({originalBlock:e,...t})=>{const{originalName:l,originalUndelimitedContent:n,clientId:o}=t.attributes,{replaceBlock:a}=(0,i.useDispatch)(m.store),s=!!n,d=(0,i.useSelect)((e=>{const{canInsertBlockType:t,getBlockRootClientId:l}=e(m.store);return t("core/html",l(o))}),[o]);let u=(0,f.sprintf)(
/* translators: %s: block name */
(0,f.__)("Your site doesn’t include support for the %s block. You can try installing the block or remove it entirely."),e.title||l);const p=[(0,r.createElement)(Be,{key:"install",block:e,attributes:t.attributes,clientId:t.clientId})];return s&&d&&(u=(0,f.sprintf)(
/* translators: %s: block name */
