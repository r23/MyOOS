...
footer:(0,m.__)("Footer"),...p},f={hidden:n?{opacity:0}:{opacity:1},hover:{opacity:1,transition:{type:"tween",delay:.2,delayChildren:.2}}};return(0,l.createElement)("div",W({},h,{ref:(0,K.useMergeRefs)([t,h.ref]),className:we()(v,"interface-interface-skeleton",h.className,!!a&&"has-footer")}),(0,l.createElement)("div",{className:"interface-interface-skeleton__editor"},!!r&&n&&(0,l.createElement)(at,{as:te.__unstableMotion.div,className:"interface-interface-skeleton__header","aria-label":_.header,initial:n?"hidden":"hover",whileHover:"hover",variants:f,transition:{type:"tween",delay:.8}},r),!!r&&!n&&(0,l.createElement)(at,{className:"interface-interface-skeleton__header",ariaLabel:_.header},r),n&&(0,l.createElement)("div",{className:"interface-interface-skeleton__header"},i),(0,l.createElement)("div",{className:"interface-interface-skeleton__body"},!!s&&(0,l.createElement)(at,{className:"interface-interface-skeleton__secondary-sidebar",ariaLabel:_.secondarySidebar},s),!!c&&(0,l.createElement)("div",{className:"interface-interface-skeleton__notices"},c),(0,l.createElement)(at,{className:"interface-interface-skeleton__content",ariaLabel:_.body},u),!!o&&(0,l.createElement)(at,{className:"interface-interface-skeleton__sidebar",ariaLabel:_.sidebar},o),!!d&&(0,l.createElement)(at,{className:"interface-interface-skeleton__actions",ariaLabel:_.actions},d))),!!a&&(0,l.createElement)(at,{className:"interface-interface-skeleton__footer",ariaLabel:_.footer},a))})),it=(0,l.createElement)(ne.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},(0,l.createElement)(ne.Path,{d:"M13 19h-2v-2h2v2zm0-6h-2v-2h2v2zm0-6h-2V5h2v2z"}));function ot(e){let{as:t=te.DropdownMenu,className:n,label:
