 ...
 * @return array Filtered editor settings.
 */
function gutenberg_gutenberg_enable_animation_for_navigation_link_inspector( $settings ) {
...
add_filter( 'block_editor_settings_all', 'gutenberg_gutenberg_enable_animation_for_navigation_link_inspector' );
