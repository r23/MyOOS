...
function gutenberg_render_block_core_navigation_submenu( $attributes, $content, $block ) {
	...
	if ( ! $open_on_click ) {
		...
		if ( $show_submenu_indicators ) {
			...
			$html .= '<button aria-label="' . $aria_label . '" class="wp-block-navigation__submenu-icon wp-block-navigation-submenu__toggle" aria-expanded="false">' . gutenberg_block_core_navigation_submenu_render_submenu_icon() . '</button>';
		}
	} else {
