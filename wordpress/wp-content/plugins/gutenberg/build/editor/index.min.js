...
/* translators: button label text should, if possible, be under 16 characters. */,label:(0,Xt.__)("Details"),tooltipPosition:"bottom","aria-disabled":!a}))},renderContent:e=>{let{onClose:t}=e;return(0,i.createElement)(As,{onRequestClose:t,hasOutlineItemsDisabled:n})}})}));function Ns(){const e=(0,l.useSelect)((e=>()=>{const{__experimentalGetDirtyEntityRecords:t}=e(c.store);return t().length>0}),[]),t=t=>{if(e())return t.returnValue=(0,Xt.__)("You have unsaved changes. If you proceed, they will be lost."),t.returnValue};return(0,i.useEffect)((()=>(window.addEventListener("beforeunload",t),()=>{window.removeEventListener("beforeunload",t)})),[]),null}var Ds=window.wp.reusableBlocks,Rs=(0,u.createHigherOrderComponent)((e=>(0,l.withRegistry)((t=>{const{useSubRegistry:n=!0,registry:o,...r}=t;if(!n)return(0,i.createElement)(e,r);const[s,a]=(0,i.useState)(null);return(0,i.useEffect)((()=>{const e=(0,l.createRegistry)({"core/block-editor":p.storeConfig},o);e.registerStore("core/editor",no),a(e)}),[o]),s?(0,i.createElement)(l.RegistryProvider,{value:s},(0,i.createElement)(e,r)):null}))),"withRegistryProvider"),Ls=window.wp.mediaUtils;const Os=()=>{};function Us(e){let{additionalData:t={},allowedTypes:n,filesList:o,maxUploadFileSize:r,onError:i=Os,onFileChange:s}=e;const{getCurrentPostId:a,getEditorSettings:c}=(0,l.select)(oo),u=c().allowedMimeTypes;r=r||c().maxUploadFileSize,(0,Ls.uploadMedia)({allowedTypes:n,filesList:o,onFileChange:s,additionalData:{post:a(),...t},maxUploadFileSize:r,onError:e=>{let{message:t}=e;return i(t)},wpAllowedMimeTypes:u})}const Fs=[];var Ms=Rs((function(e){let{__unstableTemplate:t,post:n,settings:o,recovery:r,initialEdits:s,children:a}=e;const u=(0,i.useMemo)((()=>"wp_template"===n.type?{}:{postId:n.id,postType:n.type}),[n.id,n.type]),{selection:d,isReady:m}=(0,l.useSelect)((e=>{const{getEditorSelection:t,__unstableIsEditorReady:n}=e(oo);return{isReady:n(),selection:t()}}),[]),{id:h,type:g}=null!=t?t:n,[f,v,_]=(0,c.useEntityBlockEditor)("postType",g,{id:h}),y=function(e,t){var n,o;const{reusableBlocks:r,hasUploadPermissions:s,canUseUnfilteredHTML:a,userCanCreatePages:u,pageOnFront:d,postType:p}=(0,l.useSelect)((e=>{var t;const{canUserUseUnfilteredHTML:n,getCurrentPostType:o}=e(oo),r="web"===i.Platform.OS,{canUser:s,getEntityRecord:a}=e(c.store),l=s("read","settings")?a("root","site"):void 0;return{canUseUnfilteredHTML:n(),reusableBlocks:r?e(c.store).getEntityRecords("postType","wp_block",{per_page:-1}):Fs,hasUploadPermissions:null===(t=s("create","media"))||void 0===t||t,userCanCreatePages:s("create","pages"),pageOnFront:null==l?void 0:l.page_on_front,postType:o()}}),[]),m=null!==(n=e.__experimentalAdditionalBlockPatterns)&&void 0!==n?n:e.__experimentalBlockPatterns,h=null!==(o=e.__experimentalAdditionalBlockPatternCategories)&&void 0!==o?o:e.__experimentalBlockPatternCategories,{restBlockPatterns:g,restBlockPatternCategories:f}=(0,l.useSelect)((e=>({restBlockPatterns:e(c.store).getBlockPatterns(),restBlockPatternCategories:e(c.store).getBlockPatternCategories()})),[]),v=(0,i.useMemo)((()=>[...m||[],...g||[]].filter(((e,t,n)=>t===n.findIndex((t=>e.name===t.name)))).filter((e=>{let{postTypes:t}=e;return!t||Array.isArray(t)&&t.includes(p)}))),[m,g,p]),_=(0,i.useMemo)((()=>[...h||[],...f||[]].filter(((e,t,n)=>t===n.findIndex((t=>e.name===t.name))))),[h,f]),{undo:y}=(0,l.useDispatch)(oo),{saveEntityRecord:b}=(0,l.useDispatch)(c.store),E=e=>u?b("postType","page",e):Promise.reject({message:(0,Xt.__)("You do not have permission to create Pages.")});return(0,i.useMemo)((()=>({...Object.fromEntries(Object.entries(e).filter((e=>{let[t]=e;return["__experimentalBlockDirectory","__experimentalDiscussionSettings","__experimentalFeatures","__experimentalPreferredStyleVariations","__experimentalSetIsInserterOpened","__unstableGalleryWithImageBlocks","alignWide","allowedBlockTypes","bodyPlaceholder","canLockBlocks","codeEditingEnabled","colors","disableCustomColors","disableCustomFontSizes","disableCustomSpacingSizes","disableCustomGradients","disableLayoutStyles","enableCustomLineHeight","enableCustomSpacing","enableCustomUnits","focusMode","fontSizes","gradients","generateAnchors","hasFixedToolbar","isDistractionFree","hasInlineToolbar","imageDefaultSize","imageDimensions","imageEditing","imageSizes","isRTL","keepCaretInsideBlock","maxWidth","onUpdateDefaultBlockStyles","styles","template","templateLock","titlePlaceholder","supportsLayout","widgetTypesToHideFromLegacyWidgetBlock","__unstableResolvedAssets"].includes(t)}))),mediaUpload:s?Us:void 0,__experimentalReusableBlocks:r,__experimentalBlockPatterns:v,__experimentalBlockPatternCategories:_,__experimentalFetchLinkSuggestions:(t,n)=>(0,c.__experimentalFetchLinkSuggestions)(t,n,e),__unstableFetchMedia:c.__experimentalFetchMedia,__experimentalFetchRichUrlData:c.__experimentalFetchUrlData,__experimentalCanUserUseUnfilteredHTML:a,__experimentalUndo:y,outlineMode:t,__experimentalCreatePageEntity:E,__experimentalUserCanCreatePages:u,pageOnFront:d,__experimentalPreferPatternsOnRoot:t})),[e,s,r,v,_,a,y,t,u,d])}(o,!!t),{updatePostLock:b,setupEditor:E,updateEditorSettings:S,__experimentalTearDownEditor:w}=(0,l.useDispatch)(oo),{createWarningNotice:P}=(0,l.useDispatch)(Kt.store);return(0,i.useLayoutEffect)((()=>{if(!r)return b(o.postLock),E(n,s,o.template),o.autosave&&P((0,Xt.__)("There is an autosave of this post that is more recent than the version below."),{id:"autosave-exists",actions:[{label:(0,Xt.__)("View the autosave"),url:o.autosave.editLink}]}),()=>{w()}}),[]),(0,i.useEffect)((()=>{S(o)}),[o]),m?(0,i.createElement)(c.EntityProvider,{kind:"root",type:"site"},(0,i.createElement)(c.EntityProvider,{kind:"postType",type:n.type,id:n.id},(0,i.createElement)(p.BlockContextProvider,{value:u},(0,i.createElement)(p.BlockEditorProvider,{value:f,onChange:_,onInput:v,selection:d,settings:y,useSubRegistry:!1},a,(0,i.createElement)(Ds.ReusableBlocksMenuItems,null))))):null})),zs=window.wp.serverSideRender,Hs=n.n(zs);function Vs(e,t){let n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:[];const o=(0,i.forwardRef)(((n,o)=>(w()("wp.editor."+e,{since:"5.3",alternative:"wp.blockEditor."+e,version:"6.2"}),(0,i.createElement)(t,r({ref:o},n)))));return n.forEach((n=>{o[n]=Vs(e+"."+n,t[n])})),o}function Ws(e,t){return function(){return w()("wp.editor."+e,{since:"5.3",alternative:"wp.blockEditor."+e,version:"6.2"}),t(...arguments)}}const js=Vs("RichText",p.RichText,["Content"]);js.isEmpty=Ws("RichText.isEmpty",p.RichText.isEmpty);const Gs=Vs("Autocomplete",p.Autocomplete),$s=Vs("AlignmentToolbar",p.AlignmentToolbar),Ks=Vs("BlockAlignmentToolbar",p.BlockAlignmentToolbar),Ys=Vs("BlockControls",p.BlockControls,["Slot"]),qs=Vs("BlockEdit",p.BlockEdit),Qs=Vs("BlockEditorKeyboardShortcuts",p.BlockEditorKeyboardShortcuts),Xs=Vs("BlockFormatControls",p.BlockFormatControls,["Slot"]),Zs=Vs("BlockIcon",p.BlockIcon),Js=Vs("BlockInspector",p.BlockInspector),ea=Vs("BlockList",p.BlockList),ta=Vs("BlockMover",p.BlockMover),na=Vs("BlockNavigationDropdown",p.BlockNavigationDropdown),oa=Vs("BlockSelectionClearer",p.BlockSelectionClearer),ra=Vs("BlockSettingsMenu",p.BlockSettingsMenu),ia=Vs("BlockTitle",p.BlockTitle),sa=Vs("BlockToolbar",p.BlockToolbar),aa=Vs("ColorPalette",p.ColorPalette),la=Vs("ContrastChecker",p.ContrastChecker),ca=Vs("CopyHandler",p.CopyHandler),ua=Vs("DefaultBlockAppender",p.DefaultBlockAppender),da=Vs("FontSizePicker",p.FontSizePicker),pa=Vs("Inserter",p.Inserter),ma=Vs("InnerBlocks",p.InnerBlocks,["ButtonBlockAppender","DefaultBlockAppender","Content"]),ha=Vs("InspectorAdvancedControls",p.InspectorAdvancedControls,["Slot"]),ga=Vs("InspectorControls",p.InspectorControls,["Slot"]),fa=Vs("PanelColorSettings",p.PanelColorSettings),va=Vs("PlainText",p.PlainText),_a=Vs("RichTextShortcut",p.RichTextShortcut),ya=Vs("RichTextToolbarButton",p.RichTextToolbarButton),ba=Vs("__unstableRichTextInputEvent",p.__unstableRichTextInputEvent),Ea=Vs("MediaPlaceholder",p.MediaPlaceholder),Sa=Vs("MediaUpload",p.MediaUpload),wa=Vs("MediaUploadCheck",p.MediaUploadCheck),Pa=Vs("MultiSelectScrollIntoView",p.MultiSelectScrollIntoView),ka=Vs("NavigableToolbar",p.NavigableToolbar),Ca=Vs("ObserveTyping",p.ObserveTyping),Ta=Vs("SkipToSelectedBlock",p.SkipToSelectedBlock),xa=Vs("URLInput",p.URLInput),Ba=Vs("URLInputButton",p.URLInputButton),Aa=Vs("URLPopover",p.URLPopover),Ia=Vs("Warning",p.Warning),Na=Vs("WritingFlow",p.WritingFlow),Da=Ws("createCustomColorsHOC",p.createCustomColorsHOC),Ra=Ws("getColorClassName",p.getColorClassName),La=Ws("getColorObjectByAttributeValues",p.getColorObjectByAttributeValues),Oa=Ws("getColorObjectByColorValue",p.getColorObjectByColorValue),Ua=Ws("getFontSize",p.getFontSize),Fa=Ws("getFontSizeClass",p.getFontSizeClass),Ma=Ws("withColorContext",p.withColorContext),za=Ws("withColors",p.withColors),Ha=Ws("withFontSizes",p.withFontSizes);function Va(e){return w()("wp.editor.cleanForSlug",{since:"12.7",plugin:"Gutenberg",alternative:"wp.url.cleanForSlug"}),(0,E.cleanForSlug)(e)}}(),(window.wp=window.wp||{}).editor=o}();
