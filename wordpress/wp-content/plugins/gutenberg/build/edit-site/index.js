...
var download = __webpack_require__(267);
...
function getPresetVariable(styles, context, propertyName, value) {
  ...
  const basePath = ROOT_BLOCK_NAME === context ? ['settings'] : ['settings', 'blocks', context];
  const {
    valueKey,
    path: propertyPath,
    cssVarInfix
  } = metadata;
  const presets = Object(external_lodash_["get"])(styles, [...basePath, ...propertyPath]);
  const presetObject = Object(external_lodash_["find"])(presets, preset => preset[valueKey] === value);
...
function getValueFromPresetVariable(styles, blockName, variable, [presetType, slug]) {
  ...
  const presets = (_get2 = Object(external_lodash_["get"])(styles, ['settings', 'blocks', blockName, ...metadata.path])) !== null && _get2 !== void 0 ? _get2 : Object(external_lodash_["get"])(styles, ['settings', ...metadata.path]);

  if (!presets) {
    return variable;
  }

  const presetObject = Object(external_lodash_["find"])(presets, preset => preset.slug === slug);
...
function getValueFromCustomVariable(styles, blockName, variable, path) {
  ...
  const result = (_get3 = Object(external_lodash_["get"])(styles, ['settings', 'blocks', blockName, 'custom', ...path])) !== null && _get3 !== void 0 ? _get3 : Object(external_lodash_["get"])(styles, ['settings', 'custom', ...path]);
  ...
  return Object(external_lodash_["reduce"])(external_wp_blocks_["__EXPERIMENTAL_STYLE_PROPERTY"], (declarations, {
    ...
    if (!!properties) {
      properties.forEach(prop => {
        if (!Object(external_lodash_["get"])(blockStyles, [...pathToValue, prop], false)) {
          // Do not create a declaration
          // for sub-properties that don't have any value.
          return;
        }

        const cssProperty = Object(external_lodash_["kebabCase"])(`${key}${Object(external_lodash_["capitalize"])(prop)}`);
        declarations.push(`${cssProperty}: ${compileStyleValue(Object(external_lodash_["get"])(blockStyles, [...pathToValue, prop]))}`);
      });
...
const MAX_BORDER_WIDTH = 50; // Defining empty array here instead of inline avoids unnecessary re-renders of
// color control.
...
function BorderPanel({
  ...
  const borderStyle = getStyle(name, 'borderStyle'); // Border width.

  const hasBorderWidth = useHasBorderWidthControl({
    supports,
    name
  });
  const borderWidthValue = parseInt(getStyle(name, 'borderWidth') || 0, 10); // Border radius.

  const hasBorderRadius = useHasBorderRadiusControl({
    supports,
    name
  });
  const borderRadiusValue = parseInt(getStyle(name, 'borderRadius') || 0, 10); // Border color.
  ...
  }), hasBorderWidth && Object(external_wp_element_["createElement"])(external_wp_components_["RangeControl"], {
  ...
  }), hasBorderRadius && Object(external_wp_element_["createElement"])(external_wp_components_["RangeControl"], {
...
var edit = __webpack_require__(197);
...
function BlockEditor({
  ...
  }, Object(external_wp_element_["createElement"])(external_wp_blockEditor_["BlockEditorKeyboardShortcuts"], null), Object(external_wp_element_["createElement"])(TemplatePartConverter, null), Object(external_wp_element_["createElement"])(external_wp_blockEditor_["__experimentalLinkControl"].ViewerFill, null, Object(external_wp_element_["useCallback"])(fillProps => Object(external_wp_element_["createElement"])(NavigateToLink, Object(esm_extends["a" /* default */])({}, fillProps, {
    activePage: page,
    onActivePageChange: setPage
  })), [page])), Object(external_wp_element_["createElement"])(SidebarInspectorFill, null, Object(external_wp_element_["createElement"])(external_wp_blockEditor_["BlockInspector"], null)), Object(external_wp_element_["createElement"])("div", {
    className: "edit-site-visual-editor"
  }, Object(external_wp_element_["createElement"])(external_wp_blockEditor_["BlockTools"], {
  ...
  }, Object(external_wp_element_["createElement"])(external_wp_blockEditor_["WritingFlow"], null, Object(external_wp_element_["createElement"])(external_wp_blockEditor_["BlockList"], {
...
const NavigationPanel = ({
  ...
  return (// eslint-disable-next-line jsx-a11y/no-static-element-interactions
    ...
    }, siteTitle)), Object(external_wp_element_["createElement"])("div", {
...
function Editor({
  ...
  const {
    ...
    return {
      ...
      templateType: postType,
      page: getPage(),
      template: postId ? select(external_wp_coreData_["store"]).getEntityRecord('postType', postType, postId) : null,
      entityId: postId,
  ...
  return Object(external_wp_element_["createElement"])(external_wp_element_["Fragment"], null, Object(external_wp_element_["createElement"])(URLQueryController, null), Object(external_wp_element_["createElement"])(build_module["d" /* FullscreenMode */], {
    ...
    }), !template && (settings === null || settings === void 0 ? void 0 : settings.siteUrl) && entityId && Object(external_wp_element_["createElement"])(external_wp_components_["Notice"], {
      status: "warning",
      isDismissible: false
