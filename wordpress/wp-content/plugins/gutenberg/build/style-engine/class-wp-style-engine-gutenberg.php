...
class WP_Style_Engine_Gutenberg {
	...
	public function get_block_supports_styles( $block_styles, $options ) {
		...
		$style_rules  = new WP_Style_Engine_CSS_Declarations_Gutenberg( $css_declarations );
...
/**
 * Global public interface method to WP_Style_Engine_Gutenberg->get_block_supports_styles to generate block styles from a single block style object.
 * See: https://developer.wordpress.org/block-editor/reference-guides/block-api/block-supports/
 *
 * Example usage:
 *
 * $styles = gutenberg_style_engine_get_block_supports_styles( array( 'color' => array( 'text' => '#cccccc' ) ) );
 ...
 * );
 */
function gutenberg_style_engine_get_block_supports_styles( $block_styles, $options = array() ) {
	if ( class_exists( 'WP_Style_Engine_Gutenberg' ) ) {
