 ...
 * @return string A compiled CSS string.
 */
function gutenberg_style_engine_get_stylesheet_from_store( $store_name ) {
	if ( ! class_exists( 'WP_Style_Engine_Gutenberg' ) || empty( $store_name ) ) {
		return '';
	}

	return WP_Style_Engine_Gutenberg::compile_stylesheet_from_css_rules( WP_Style_Engine_Gutenberg::get_store( $store_name )->get_all_rules() );
}
