...
(0,o.__)("%s: This file is empty."),e.name),file:e}):(w.push(e),m.push({url:(0,u.createBlobURL)(e)}),s(m)):r({code:"MIME_TYPE_NOT_SUPPORTED",message:(0,o.sprintf)(// translators: %s: file name.
(0,o.__)("%s: Sorry, this file type is not supported here."),e.name),file:e});var b;for(let e=0;e<w.length;++e){const t=w[e];try{var S,_;const o=await g(t,i),{alt_text:l,source_url:a,...r}=o;p(e,{...r,alt:o.alt_text,caption:null!==(S=null===(_=o.caption)||void 0===_?void 0:_.raw)&&void 0!==S?S:"",title:o.title.raw,url:o.source_url})}catch(i){let l;p(e,null),l=i.message?i.message:(0,o.sprintf)(// translators: %s: file name
