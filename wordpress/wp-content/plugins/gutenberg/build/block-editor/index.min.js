...
(0,g._n)("%d block","%d blocks",e),e)),(0,s.createElement)(p.FlexItem,null,(0,s.createElement)(za,{icon:uu})))))}var pu=({isEnabled:e,blocks:t,icon:n,children:o})=>{const r={type:"inserter",blocks:t};return(0,s.createElement)(p.Draggable,{__experimentalTransferDataType:"wp-blocks",transferData:r,__experimentalDragComponent:(0,s.createElement)(du,{count:t.length,icon:n})},(({onDraggableStart:t,onDraggableEnd:n})=>o({draggable:e,onDragStart:e?t:void 0,onDragEnd:e?n:void 0})))};function mu(e=window){const{platform:t}=e.navigator;return-1!==t.indexOf("Mac")||["iPad","iPhone"].includes(t)}var fu=(0,s.memo)((function({className:e,isFirst:t,item:n,onSelect:o,onHover:l,isDraggable:a,...u}){const d=(0,s.useRef)(!1),p=n.icon?{backgroundColor:n.icon.background,color:n.icon.foreground}:{},m=(0,s.useMemo)((()=>[(0,r.createBlock)(n.name,n.initialAttributes,(0,r.createBlocksFromInnerBlocksTemplate)(n.innerBlocks))]),[n.name,n.initialAttributes,n.initialAttributes]);return(0,s.createElement)(pu,{isEnabled:a&&!n.disabled,blocks:m,icon:n.icon},(({draggable:r,onDragStart:a,onDragEnd:m})=>(0,s.createElement)("div",{className:"block-editor-block-types-list__list-item",draggable:r,onDragStart:e=>{d.current=!0,a&&(l(null),a(e))},onDragEnd:e=>{d.current=!1,m&&m(e)}},(0,s.createElement)(cu,i({isFirst:t,className:c()("block-editor-block-types-list__item",e),disabled:n.isDisabled,onClick:e=>{e.preventDefault(),o(n,mu()?e.metaKey:e.ctrlKey),l(null)},onKeyDown:e=>{const{keyCode:t}=e;t===fa.ENTER&&(e.preventDefault(),o(n,mu()?e.metaKey:e.ctrlKey),l(null))},onFocus:()=>{d.current||l(n)},onMouseEnter:()=>{d.current||l(n)},onMouseLeave:()=>l(null),onBlur:()=>l(null)},u),(0,s.createElement)("span",{className:"block-editor-block-types-list__item-icon",style:p},(0,s.createElement)(za,{icon:n.icon,showColors:!0})),(0,s.createElement)("span",{className:"block-editor-block-types-list__item-title"},n.title)))))})),gu=(0,s.forwardRef)((function(e,t){const[n,o]=(0,s.useState)(!1);return(0,s.useEffect)((()=>{n&&(0,Rt.speak)((0,g.__)("Use left and right arrow keys to move through blocks"))}),[n]),(0,s.createElement)("div",i({ref:t,role:"listbox","aria-orientation":"horizontal",onFocus:()=>{o(!0)},onBlur:e=>{!e.currentTarget.contains(e.relatedTarget)&&o(!1)}},e))})),hu=(0,s.forwardRef)((function(e,t){const n=(0,s.useContext)(au);return(0,s.createElement)(p.__unstableCompositeGroup,i({state:n,role:"presentation",ref:t},e))})),bu=function({items:e=[],onSelect:t,onHover:n=(()=>{}),children:o,label:l,isDraggable:i=!0}){return(0,s.createElement)(gu,{className:"block-editor-block-types-list","aria-label":l},function(e,t){const n=[];for(let t=0,o=e.length;t<o;t+=3)n.push(e.slice(t,t+3));return n}(e).map(((e,o)=>(0,s.createElement)(hu,{key:o},e.map(((e,l)=>(0,s.createElement)(fu,{key:e.id,item:e,className:(0,r.getBlockMenuDefaultClassName)(e.id),onSelect:t,onHover:n,isDraggable:i,isFirst:0===o&&0===l})))))),o)},vu=function({title:e,icon:t,children:n}){return(0,s.createElement)(s.Fragment,null,(0,s.createElement)("div",{className:"block-editor-inserter__panel-header"},(0,s.createElement)("h2",{className:"block-editor-inserter__panel-title"},e),(0,s.createElement)(p.Icon,{icon:t})),(0,s.createElement)("div",{className:"block-editor-inserter__panel-content"},n))},ku=(e,t)=>{const{categories:n,collections:o,items:l}=(0,m.useSelect)((t=>{const{getInserterItems:n}=t(Wn),{getCategories:o,getCollections:l}=t(r.store);return{categories:o(),collections:l(),items:n(e)}}),[e]);return[l,n,o,(0,s.useCallback)((({name:e,initialAttributes:n,innerBlocks:o},l)=>{const i=(0,r.createBlock)(e,n,(0,r.createBlocksFromInnerBlocksTemplate)(o));t(i,void 0,l)}),[t])]},_u=function({children:e}){const t=(0,p.__unstableUseCompositeState)({shift:!0,wrap:"horizontal"});return(0,s.createElement)(au.Provider,{value:t},e)};const yu=[];var Eu=function({rootClientId:e,onInsert:t,onHover:n,showMostUsedBlocks:o}){const[r,l,i,a]=ku(e,t),c=(0,s.useMemo)((()=>(0,u.orderBy)(r,["frecency"],["desc"]).slice(0,6)),[r]),p=(0,s.useMemo)((()=>r.filter((e=>!e.category))),[r]),m=(0,s.useMemo)((()=>(0,u.flow)((e=>e.filter((e=>e.category&&"reusable"!==e.category))),(e=>(0,u.groupBy)(e,"category")))(r)),[r]),f=(0,s.useMemo)((()=>{const e={...i};return Object.keys(i).forEach((t=>{e[t]=r.filter((e=>(e=>e.name.split("/")[0])(e)===t)),0===e[t].length&&delete e[t]})),e}),[r,i]);(0,s.useEffect)((()=>()=>n(null)),[]);const h=(0,d.useAsyncList)(l),b=l.length===h.length,v=(0,s.useMemo)((()=>Object.entries(i)),[i]),k=(0,d.useAsyncList)(b?v:yu);return(0,s.createElement)(_u,null,(0,s.createElement)("div",null,o&&!!c.length&&(0,s.createElement)(vu,{title:(0,g._x)("Most used","blocks")},(0,s.createElement)(bu,{items:c,onSelect:a,onHover:n,label:(0,g._x)("Most used","blocks")})),(0,u.map)(h,(e=>{const t=m[e.slug];return t&&t.length?(0,s.createElement)(vu,{key:e.slug,title:e.title,icon:e.icon},(0,s.createElement)(bu,{items:t,onSelect:a,onHover:n,label:e.title})):null})),b&&p.length>0&&(0,s.createElement)(vu,{className:"block-editor-inserter__uncategorized-blocks-panel",title:(0,g.__)("Uncategorized")},(0,s.createElement)(bu,{items:p,onSelect:a,onHover:n,label:(0,g.__)("Uncategorized")})),(0,u.map)(k,(([e,t])=>{const o=f[e];return o&&o.length?(0,s.createElement)(vu,{key:e,title:t.title,icon:t.icon},(0,s.createElement)(bu,{items:o,onSelect:a,onHover:n,label:t.title})):null}))))},Cu=function({selectedCategory:e,patternCategories:t,onClickCategory:n,children:o}){return(0,s.createElement)(s.Fragment,null,(0,s.createElement)("div",{className:c()("block-editor-inserter__panel-header","block-editor-inserter__panel-header-patterns")},(0,s.createElement)(p.SelectControl,{className:"block-editor-inserter__panel-dropdown",label:(0,g.__)("Filter patterns"),hideLabelFromVision:!0,value:e.name,onChange:e=>{n(t.find((t=>e===t.name)))},onBlur:e=>{null!=e&&e.relatedTarget||e.stopPropagation()},options:(()=>{const e=[];return t.map((t=>e.push({value:t.name,label:t.label}))),e})()})),(0,s.createElement)("div",{className:"block-editor-inserter__panel-content"},o))},Su=window.wp.notices,wu=(e,t)=>{const{patternCategories:n,patterns:o}=(0,m.useSelect)((e=>{const{__experimentalGetAllowedPatterns:n,getSettings:o}=e(Wn);return{patterns:n(t),patternCategories:o().__experimentalBlockPatternCategories}}),[t]),{createSuccessNotice:l}=(0,m.useDispatch)(Su.store);return[o,n,(0,s.useCallback)(((t,n)=>{e((0,u.map)(n,(e=>(0,r.cloneBlock)(e))),t.name),l((0,g.sprintf)(
/* translators: %s: block pattern title. */
(0,g.__)('Block pattern "%s" inserted.'),t.title),{type:"snackbar"})}),[])]};function Bu({isDraggable:e,pattern:t,onClick:n,composite:o}){const{name:r,viewportWidth:l}=t,{blocks:a}=(0,m.useSelect)((e=>e(Wn).__experimentalGetParsedPattern(r)),[r]),c=`block-editor-block-patterns-list__item-description-${(0,d.useInstanceId)(Bu)}`;return(0,s.createElement)(pu,{isEnabled:e,blocks:a},(({draggable:e,onDragStart:r,onDragEnd:u})=>(0,s.createElement)("div",{className:"block-editor-block-patterns-list__list-item","aria-label":t.title,"aria-describedby":t.description?c:void 0,draggable:e,onDragStart:r,onDragEnd:u},(0,s.createElement)(p.__unstableCompositeItem,i({role:"option",as:"div"},o,{className:"block-editor-block-patterns-list__item",onClick:()=>n(t,a)}),(0,s.createElement)(iu,{blocks:a,viewportWidth:l}),(0,s.createElement)("div",{className:"block-editor-block-patterns-list__item-title"},t.title),!!t.description&&(0,s.createElement)(p.VisuallyHidden,{id:c},t.description)))))}function Iu(){return(0,s.createElement)("div",{className:"block-editor-block-patterns-list__item is-placeholder"})}var xu=function({isDraggable:e,blockPatterns:t,shownPatterns:n,onClickPattern:o,orientation:r,label:l=(0,g.__)("Block Patterns")}){const a=(0,p.__unstableUseCompositeState)({orientation:r});return(0,s.createElement)(p.__unstableComposite,i({},a,{role:"listbox",className:"block-editor-block-patterns-list","aria-label":l}),t.map((t=>n.includes(t)?(0,s.createElement)(Bu,{key:t.name,pattern:t,onClick:o,isDraggable:e,composite:a}):(0,s.createElement)(Iu,{key:t.name}))))};function Tu({rootClientId:e,onInsert:t,selectedCategory:n,onClickCategory:o}){const[r,l,i]=wu(t,e),a=(0,s.useMemo)((()=>l.filter((e=>r.some((t=>{var n;return null===(n=t.categories)||void 0===n?void 0:n.includes(e.name)})))).sort((({name:e},{name:t})=>[e,t].includes("featured")?"featured"===e?-1:1:0))),[r,l]),c=n||a[0];(0,s.useEffect)((()=>{r.some((e=>p(e)===1/0))&&!a.find((e=>"uncategorized"===e.name))&&a.push({name:"uncategorized",label:(0,g._x)("Uncategorized")})}),[a,r]);const p=(0,s.useCallback)((e=>{if(!e.categories||!e.categories.length)return 1/0;const t=(0,u.fromPairs)(a.map((({name:e},t)=>[e,t])));return Math.min(...e.categories.map((e=>void 0!==t[e]?t[e]:1/0)))}),[a]),m=(0,s.useMemo)((()=>r.filter((e=>"uncategorized"===c.name?p(e)===1/0:e.categories&&e.categories.includes(c.name)))),[r,c]),f=(0,s.useMemo)((()=>m.sort(((e,t)=>p(e)-p(t)))),[m,p]),h=(0,d.useAsyncList)(f);return(0,s.createElement)(s.Fragment,null,!!m.length&&(0,s.createElement)(Cu,{selectedCategory:c,patternCategories:a,onClickCategory:o},(0,s.createElement)(xu,{shownPatterns:h,blockPatterns:m,onClickPattern:i,label:c.label,orientation:"vertical",isDraggable:!0})))}var Nu=function({rootClientId:e,onInsert:t,onClickCategory:n,selectedCategory:o}){return(0,s.createElement)(Tu,{rootClientId:e,selectedCategory:o,onInsert:t,onClickCategory:n})},Pu=window.wp.url,Ru=function(){return(0,s.createElement)("div",{className:"block-editor-inserter__no-results"},(0,s.createElement)(Co,{className:"block-editor-inserter__no-results-icon",icon:Fa}),(0,s.createElement)("p",null,(0,g.__)("No results found.")))};function Mu({onHover:e,onInsert:t,rootClientId:n}){const[o,,,r]=ku(n,t),l=(0,s.useMemo)((()=>o.filter((({category:e})=>"reusable"===e))),[o]);return 0===l.length?(0,s.createElement)(Ru,null):(0,s.createElement)(vu,{title:(0,g.__)("Reusable blocks")},(0,s.createElement)(bu,{items:l,onSelect:r,onHover:e,label:(0,g.__)("Reusable blocks")}))}var Lu=function({rootClientId:e,onInsert:t,onHover:n}){return(0,s.createElement)(s.Fragment,null,(0,s.createElement)(Mu,{onHover:n,onInsert:t,rootClientId:e}),(0,s.createElement)("div",{className:"block-editor-inserter__manage-reusable-blocks-container"},(0,s.createElement)("a",{className:"block-editor-inserter__manage-reusable-blocks",href:(0,Pu.addQueryArgs)("edit.php",{post_type:"wp_block"})},(0,g.__)("Manage Reusable blocks"))))};const{Fill:Au,Slot:Du}=(0,p.createSlotFill)("__unstableInserterMenuExtension");Au.Slot=Du;var Ou=Au,Fu=function({rootClientId:e="",insertionIndex:t,clientId:n,isAppender:o,onSelect:l,shouldFocusBlock:i=!0}){const{getSelectedBlock:a}=(0,m.useSelect)(Wn),{destinationRootClientId:c,destinationIndex:d}=(0,m.useSelect)((r=>{const{getSelectedBlockClientId:l,getBlockRootClientId:i,getBlockIndex:s,getBlockOrder:a}=r(Wn),c=l();let u,d=e;return void 0!==t?u=t:n?u=s(n,d):!o&&c?(d=i(c),u=s(c,d)+1):u=a(d).length,{destinationRootClientId:d,destinationIndex:u}}),[e,t,n,o]),{replaceBlocks:p,insertBlocks:f,showInsertionPoint:h,hideInsertionPoint:b}=(0,m.useDispatch)(Wn),v=(0,s.useCallback)(((e,t,n=!1)=>{const s=a();!o&&s&&(0,r.isUnmodifiedDefaultBlock)(s)?p(s.clientId,e,null,i||n?0:null,t):f(e,d,c,!0,i||n?0:null,t);const m=(0,g.sprintf)(// translators: %d: the name of the block that has been added
(0,g._n)("%d block added.","%d blocks added.",(0,u.castArray)(e).length),(0,u.castArray)(e).length);(0,Rt.speak)(m),l&&l()}),[o,a,p,f,c,d,l,i]),k=(0,s.useCallback)((e=>{e?h(c,d):b()}),[h,b,c,d]);return[c,v,k]};const zu=e=>e.name||"",Vu=e=>e.title,Hu=e=>e.description||"",Uu=e=>e.keywords||[],Gu=e=>e.category,Wu=()=>null;function $u(e=""){return(e=(e=(0,u.deburr)(e)).replace(/^\//,"")).toLowerCase()}const ju=(e="")=>(0,u.words)($u(e)),Ku=(e,t,n,o)=>0===ju(o).length?e:qu(e,o,{getCategory:e=>{var n;return null===(n=(0,u.find)(t,{slug:e.category}))||void 0===n?void 0:n.title},getCollection:e=>{var t;return null===(t=n[e.name.split("/")[0]])||void 0===t?void 0:t.title}}),qu=(e=[],t="",n={})=>{if(0===ju(t).length)return e;const o=e.map((e=>[e,Yu(e,t,n)])).filter((([,e])=>e>0));return o.sort((([,e],[,t])=>t-e)),o.map((([e])=>e))};function Yu(e,t,n={}){const{getName:o=zu,getTitle:r=Vu,getDescription:l=Hu,getKeywords:i=Uu,getCategory:s=Gu,getCollection:a=Wu}=n,c=o(e),d=r(e),p=l(e),m=i(e),f=s(e),g=a(e),h=$u(t),b=$u(d);let v=0;if(h===b)v+=30;else if(b.startsWith(h))v+=20;else{const e=[c,d,p,...m,f,g].join(" ");0===(k=(0,u.words)(h),_=e,(0,u.differenceWith)(k,ju(_),((e,t)=>t.includes(e)))).length&&(v+=10)}var k,_;return 0!==v&&c.startsWith("core/")&&v++,v}const Zu=[];var Xu=function({filterValue:e,onSelect:t,onHover:n,rootClientId:o,clientId:r,isAppender:l,__experimentalInsertionIndex:i,maxBlockPatterns:a,maxBlockTypes:c,showBlockDirectory:m=!1,isDraggable:f=!0,shouldFocusBlock:h=!0}){const b=(0,d.useDebounce)(Rt.speak,500),[v,k]=Fu({onSelect:t,rootClientId:o,clientId:r,isAppender:l,insertionIndex:i,shouldFocusBlock:h}),[_,y,E,C]=ku(v,k),[S,,w]=wu(k,v),B=(0,s.useMemo)((()=>{const t=Ku((0,u.orderBy)(_,["frecency"],["desc"]),y,E,e);return void 0!==c?t.slice(0,c):t}),[e,_,y,E,c]),I=(0,s.useMemo)((()=>{const t=qu(S,e);return void 0!==a?t.slice(0,a):t}),[e,S,a]);(0,s.useEffect)((()=>{if(!e)return;const t=B.length+I.length,n=(0,g.sprintf)(
/* translators: %d: number of results. */
(0,g._n)("%d result found.","%d results found.",t),t);b(n)}),[e,b]);const x=(0,d.useAsyncList)(B,{step:9}),T=(0,d.useAsyncList)(x.length===B.length?I:Zu),N=!(0,u.isEmpty)(B)||!(0,u.isEmpty)(I);return(0,s.createElement)(_u,null,!m&&!N&&(0,s.createElement)(Ru,null),!!B.length&&(0,s.createElement)(vu,{title:(0,s.createElement)(p.VisuallyHidden,null,(0,g.__)("Blocks"))},(0,s.createElement)(bu,{items:x,onSelect:C,onHover:n,label:(0,g.__)("Blocks"),isDraggable:f})),!!B.length&&!!I.length&&(0,s.createElement)("div",{className:"block-editor-inserter__quick-inserter-separator"}),!!I.length&&(0,s.createElement)(vu,{title:(0,s.createElement)(p.VisuallyHidden,null,(0,g.__)("Block Patterns"))},(0,s.createElement)("div",{className:"block-editor-inserter__quick-inserter-patterns"},(0,s.createElement)(xu,{shownPatterns:T,blockPatterns:I,onClickPattern:w,isDraggable:f}))),m&&(0,s.createElement)(Ou.Slot,{fillProps:{onSelect:C,onHover:n,filterValue:e,hasItems:N,rootClientId:v}},(e=>e.length?e:N?null:(0,s.createElement)(Ru,null))))};const Qu={name:"blocks",
/* translators: Blocks tab title in the block inserter. */
title:(0,g.__)("Blocks")},Ju={name:"patterns",
/* translators: Patterns tab title in the block inserter. */
title:(0,g.__)("Patterns")},ed={name:"reusable",
/* translators: Reusable blocks tab title in the block inserter. */
title:(0,g.__)("Reusable")};var td=function({children:e,showPatterns:t=!1,showReusableBlocks:n=!1,onSelect:o}){const r=(0,s.useMemo)((()=>{const e=[Qu];return t&&e.push(Ju),n&&e.push(ed),e}),[Qu,t,Ju,n,ed]);return(0,s.createElement)(p.TabPanel,{className:"block-editor-inserter__tabs",tabs:r,onSelect:o},e)},nd=function({rootClientId:e,clientId:t,isAppender:n,__experimentalInsertionIndex:o,onSelect:r,showInserterHelpPanel:l,showMostUsedBlocks:i,__experimentalFilterValue:a="",shouldFocusBlock:c=!0}){const[u,d]=(0,s.useState)(a),[f,h]=(0,s.useState)(null),[b,v]=(0,s.useState)(null),[k,_,y]=Fu({rootClientId:e,clientId:t,isAppender:n,insertionIndex:o,shouldFocusBlock:c}),{showPatterns:E,hasReusableBlocks:C}=(0,m.useSelect)((e=>{var t;const{__experimentalGetAllowedPatterns:n,getSettings:o}=e(Wn);return{showPatterns:!!n(k).length,hasReusableBlocks:!(null===(t=o().__experimentalReusableBlocks)||void 0===t||!t.length)}}),[k]),S=(0,s.useCallback)(((e,t,n)=>{_(e,t,n),r()}),[_,r]),w=(0,s.useCallback)(((e,t)=>{_(e,{patternName:t}),r()}),[_,r]),B=(0,s.useCallback)((e=>{y(!!e),h(e)}),[y,h]),I=(0,s.useCallback)((e=>{v(e)}),[v]),x=(0,s.useMemo)((()=>(0,s.createElement)(s.Fragment,null,(0,s.createElement)("div",{className:"block-editor-inserter__block-list"},(0,s.createElement)(Eu,{rootClientId:k,onInsert:S,onHover:B,showMostUsedBlocks:i})),l&&(0,s.createElement)("div",{className:"block-editor-inserter__tips"},(0,s.createElement)(p.VisuallyHidden,{as:"h2"},(0,g.__)("A tip for using the block editor")),(0,s.createElement)(Oa,null)))),[k,S,B,u,i,l]),T=(0,s.useMemo)((()=>(0,s.createElement)(Nu,{rootClientId:k,onInsert:w,onClickCategory:I,selectedCategory:b})),[k,w,I,b]),N=(0,s.useMemo)((()=>(0,s.createElement)(Lu,{rootClientId:k,onInsert:S,onHover:B})),[k,S,B]),P=(0,s.useCallback)((e=>"blocks"===e.name?x:"patterns"===e.name?T:N),[x,T,N]);return(0,s.createElement)("div",{className:"block-editor-inserter__menu"},(0,s.createElement)("div",{className:"block-editor-inserter__main-area"},(0,s.createElement)("div",{className:"block-editor-inserter__content"},(0,s.createElement)(p.SearchControl,{className:"block-editor-inserter__search",onChange:e=>{f&&h(null),d(e)},value:u,label:(0,g.__)("Search for blocks and patterns"),placeholder:(0,g.__)("Search")}),!!u&&(0,s.createElement)(Xu,{filterValue:u,onSelect:r,onHover:B,rootClientId:e,clientId:t,isAppender:n,__experimentalInsertionIndex:o,showBlockDirectory:!0,shouldFocusBlock:c}),!u&&(E||C)&&(0,s.createElement)(td,{showPatterns:E,showReusableBlocks:C},P),!u&&!E&&!C&&x)),l&&f&&(0,s.createElement)(su,{item:f}))};function od({onSelect:e,rootClientId:t,clientId:n,isAppender:o}){const[r,l]=(0,s.useState)(""),[i,a]=Fu({onSelect:e,rootClientId:t,clientId:n,isAppender:o}),[u]=ku(i,a),[d]=wu(a,i),f=d.length&&!!r,h=f&&d.length>6||u.length>6,{setInserterIsOpened:b,insertionIndex:v}=(0,m.useSelect)((e=>{const{getSettings:o,getBlockIndex:r,getBlockCount:l}=e(Wn),i=r(n,t);return{setInserterIsOpened:o().__experimentalSetIsInserterOpened,insertionIndex:-1===i?l():i}}),[n,t]);return(0,s.useEffect)((()=>{b&&b(!1)}),[b]),(0,s.createElement)("div",{className:c()("block-editor-inserter__quick-inserter",{"has-search":h,"has-expand":b})},h&&(0,s.createElement)(p.SearchControl,{className:"block-editor-inserter__search",value:r,onChange:e=>{l(e)},label:(0,g.__)("Search for blocks and patterns"),placeholder:(0,g.__)("Search")}),(0,s.createElement)("div",{className:"block-editor-inserter__quick-inserter-results"},(0,s.createElement)(Xu,{filterValue:r,onSelect:e,rootClientId:t,clientId:n,isAppender:o,maxBlockPatterns:f?2:0,maxBlockTypes:6,isDraggable:!1})),b&&(0,s.createElement)(p.Button,{className:"block-editor-inserter__quick-inserter-expand",onClick:()=>{b({rootClientId:t,insertionIndex:v,filterValue:r})},"aria-label":(0,g.__)("Browse all. This will open the main inserter panel in the editor toolbar.")},(0,g.__)("Browse all")))}const rd=({onToggle:e,disabled:t,isOpen:n,blockTitle:o,hasSingleBlockType:r,toggleProps:l={}})=>{let a;a=r?(0,g.sprintf)(// translators: %s: the name of the block when there is only one
(0,g._x)("Add %s","directly add the only allowed block"),o):(0,g._x)("Add block","Generic label for block inserter button");const{onClick:c,...u}=l;return(0,s.createElement)(p.Button,i({icon:Aa,label:a,tooltipPosition:"bottom",onClick:function(t){e&&e(t),c&&c(t)},className:"block-editor-inserter__toggle","aria-haspopup":!r&&"true","aria-expanded":!r&&n,disabled:t},u))};class ld extends s.Component{constructor(){super(...arguments),this.onToggle=this.onToggle.bind(this),this.renderToggle=this.renderToggle.bind(this),this.renderContent=this.renderContent.bind(this)}onToggle(e){const{onToggle:t}=this.props;t&&t(e)}renderToggle({onToggle:e,isOpen:t}){const{disabled:n,blockTitle:o,hasSingleBlockType:r,directInsertBlock:l,toggleProps:i,hasItems:s,renderToggle:a=rd}=this.props;return a({onToggle:e,isOpen:t,disabled:n||!s,blockTitle:o,hasSingleBlockType:r,directInsertBlock:l,toggleProps:i})}renderContent({onClose:e}){const{rootClientId:t,clientId:n,isAppender:o,showInserterHelpPanel:r,__experimentalIsQuick:l}=this.props;return l?(0,s.createElement)(od,{onSelect:()=>{e()},rootClientId:t,clientId:n,isAppender:o}):(0,s.createElement)(nd,{onSelect:()=>{e()},rootClientId:t,clientId:n,isAppender:o,showInserterHelpPanel:r})}render(){const{position:e,hasSingleBlockType:t,directInsertBlock:n,insertOnlyAllowedBlock:o,__experimentalIsQuick:r,onSelectOrClose:l}=this.props;return t||null!=n&&n.length?this.renderToggle({onToggle:o}):(0,s.createElement)(p.Dropdown,{className:"block-editor-inserter",contentClassName:c()("block-editor-inserter__popover",{"is-quick":r}),position:e,onToggle:this.onToggle,expandOnMobile:!0,headerTitle:(0,g.__)("Add a block"),renderToggle:this.renderToggle,renderContent:this.renderContent,onClose:l})}}var id=(0,d.compose)([(0,m.withSelect)(((e,{clientId:t,rootClientId:n})=>{const{getBlockRootClientId:o,hasInserterItems:l,__experimentalGetAllowedBlocks:i,__experimentalGetDirectInsertBlock:s}=e(Wn),{getBlockVariations:a}=e(r.store),c=i(n=n||o(t)||void 0),d=s(n),p=1===(0,u.size)(c)&&0===(0,u.size)(a(c[0].name,"inserter"));let m=!1;return p&&(m=c[0]),{hasItems:l(n),hasSingleBlockType:p,blockTitle:m?m.title:"",allowedBlockType:m,directInsertBlock:d,rootClientId:n}})),(0,m.withDispatch)(((e,t,{select:n})=>({insertOnlyAllowedBlock(){const{rootClientId:o,clientId:l,isAppender:i,hasSingleBlockType:s,allowedBlockType:a,directInsertBlock:c,onSelectOrClose:u}=t;if(!(s||null!=c&&c.length))return;const{insertBlock:d}=e(Wn);d(null!=c&&c.length?(0,r.createBlock)(...c):(0,r.createBlock)(a.name),function(){const{getBlockIndex:e,getBlockSelectionEnd:t,getBlockOrder:r,getBlockRootClientId:s}=n(Wn);if(l)return e(l,o);const a=t();return!i&&a&&s(a)===o?e(a,o)+1:r(o).length}(),o),u&&u();const p=(0,g.sprintf)(// translators: %s: the name of the block that has been added
(0,g.__)("%s block added"),a.title);(0,Rt.speak)(p)}}))),(0,d.ifCondition)((({hasItems:e,isAppender:t,rootClientId:n,clientId:o})=>e||!t&&!n&&!o))])(ld),sd=(0,d.compose)((0,m.withSelect)(((e,t)=>{const{getBlockCount:n,getBlockName:o,isBlockValid:l,getSettings:i,getTemplateLock:s}=e(Wn),a=!n(t.rootClientId),c=o(t.lastBlockClientId)===(0,r.getDefaultBlockName)(),u=l(t.lastBlockClientId),{bodyPlaceholder:d}=i();return{isVisible:a||!c||!u,showPrompt:a,isLocked:!!s(t.rootClientId),placeholder:d}})),(0,m.withDispatch)(((e,t)=>{const{insertDefaultBlock:n,startTyping:o}=e(Wn);return{onAppend(){const{rootClientId:e}=t;n(void 0,e),o()}}})))((function({isLocked:e,isVisible:t,onAppend:n,showPrompt:o,placeholder:r,rootClientId:l}){if(e||!t)return null;const i=(0,La.decodeEntities)(r)||(0,g.__)("Type / to choose a block");return(0,s.createElement)("div",{"data-root-client-id":l||"",className:c()("block-editor-default-block-appender",{"has-visible-prompt":o})},(0,s.createElement)("p",{tabIndex:"0",contentEditable:!0,suppressContentEditableWarning:!0,role:"button","aria-label":(0,g.__)("Add block"),className:"block-editor-default-block-appender__content",onFocus:n},o?i:"\ufeff"),(0,s.createElement)(id,{rootClientId:l,position:"bottom right",isAppender:!0,__experimentalIsQuick:!0}))}));function ad({rootClientId:e,className:t,onFocus:n,tabIndex:o},r){return(0,s.createElement)(id,{position:"bottom center",rootClientId:e,__experimentalIsQuick:!0,renderToggle:({onToggle:e,disabled:l,isOpen:i,blockTitle:a,hasSingleBlockType:u})=>{let d;d=u?(0,g.sprintf)(// translators: %s: the name of the block when there is only one
...
(0,g.__)("Block %1$s is at the beginning of the content and can’t be moved right"),t)}}(f,h&&h.title,y,k,_,"up"===t?-1:1,E)))})),Rd=(0,s.forwardRef)(((e,t)=>(0,s.createElement)(Pd,i({direction:"up",ref:t},e)))),Md=(0,s.forwardRef)(((e,t)=>(0,s.createElement)(Pd,i({direction:"down",ref:t},e))));var Ld=(0,m.withSelect)(((e,{clientIds:t})=>{var n;const{getBlock:o,getBlockIndex:l,getBlockListSettings:i,canMoveBlocks:s,getBlockOrder:a,getBlockRootClientId:c}=e(Wn),d=(0,u.castArray)(t),p=(0,u.first)(d),m=o(p),f=c((0,u.first)(d)),g=l(p,f),h=0===g,b=l((0,u.last)(d),f)===a(f).length-1;return{blockType:m?(0,r.getBlockType)(m.name):null,canMove:s(t,f),rootClientId:f,firstIndex:g,isFirst:h,isLast:b,orientation:null===(n=i(f))||void 0===n?void 0:n.orientation}}))((function({isFirst:e,isLast:t,clientIds:n,canMove:o,isHidden:r,rootClientId:l,orientation:a,hideDragHandle:u}){const[d,m]=(0,s.useState)(!1),f=()=>m(!0),h=()=>m(!1);if(!o||e&&t&&!l)return null;const b=(0,g.__)("Drag");return(0,s.createElement)("div",{className:c()("block-editor-block-mover",{"is-visible":d||!r,"is-horizontal":"horizontal"===a})},!u&&(0,s.createElement)(yd,{clientIds:n,cloneClassname:"block-editor-block-mover__drag-clone"},(e=>(0,s.createElement)(p.Button,i({icon:uu,className:"block-editor-block-mover__drag-handle","aria-hidden":"true",label:b,tabIndex:"-1"},e)))),(0,s.createElement)(p.ToolbarGroup,{className:"block-editor-block-mover__move-button-container"},(0,s.createElement)(p.ToolbarItem,{onFocus:f,onBlur:h},(e=>(0,s.createElement)(Rd,i({clientIds:n},e)))),(0,s.createElement)(p.ToolbarItem,{onFocus:f,onBlur:h},(e=>(0,s.createElement)(Md,i({clientIds:n},e))))))}));const{clearTimeout:Ad,setTimeout:Dd}=window;function Od({ref:e,isFocused:t,debounceTimeout:n=200,onChange:o=u.noop}){const[r,l]=(0,s.useState)(!1),i=(0,s.useRef)(),a=t=>{null!=e&&e.current&&l(t),o(t)},c=()=>{const e=i.current;e&&Ad&&Ad(e)};return(0,s.useEffect)((()=>()=>c()),[]),{showMovers:r,debouncedShowMovers:e=>{e&&e.stopPropagation(),c(),r||a(!0)},debouncedHideMovers:o=>{o&&o.stopPropagation(),c(),i.current=Dd((()=>{(()=>{const n=(null==e?void 0:e.current)&&e.current.matches(":hover");return!t&&!n})()&&a(!1)}),n)}}}function Fd({ref:e,debounceTimeout:t=200,onChange:n=u.noop}){const[o,r]=(0,s.useState)(!1),{showMovers:l,debouncedShowMovers:i,debouncedHideMovers:a}=Od({ref:e,debounceTimeout:t,isFocused:o,onChange:n}),c=(0,s.useRef)(!1),d=()=>(null==e?void 0:e.current)&&e.current.contains(e.current.ownerDocument.activeElement);return(0,s.useEffect)((()=>{const t=e.current,n=()=>{d()&&(r(!0),i())},o=()=>{d()||(r(!1),a())};return t&&!c.current&&(t.addEventListener("focus",n,!0),t.addEventListener("blur",o,!0),c.current=!0),()=>{t&&(t.removeEventListener("focus",n),t.removeEventListener("blur",o))}}),[e,c,r,i,a]),{showMovers:l,gestures:{onMouseMove:i,onMouseLeave:a}}}function zd(){const{selectBlock:e,toggleBlockHighlight:t}=(0,m.useDispatch)(Wn),{firstParentClientId:n,shouldHide:o,hasReducedUI:l}=(0,m.useSelect)((e=>{const{getBlockName:t,getBlockParents:n,getSelectedBlockClientId:o,getSettings:l}=e(Wn),{hasBlockSupport:i}=e(r.store),s=n(o()),a=s[s.length-1],c=t(a),u=(0,r.getBlockType)(c),d=l();return{firstParentClientId:a,shouldHide:!i(u,"__experimentalParentSelector",!0),hasReducedUI:d.hasReducedUI}}),[]),a=kd(n),c=(0,s.useRef)(),{gestures:u}=Fd({ref:c,onChange(e){e&&l||t(n,e)}});return o||void 0===n?null:(0,s.createElement)("div",i({className:"block-editor-block-parent-selector",key:n,ref:c},u),(0,s.createElement)(p.ToolbarButton,{className:"block-editor-block-parent-selector__button",onClick:()=>e(n),label:(0,g.sprintf)(
/* translators: %s: Name of the block's parent. */
(0,g.__)("Select %s"),a.title),showTooltip:!0,icon:(0,s.createElement)(za,{icon:a.icon})}))}var Vd=(0,s.createElement)(F.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},(0,s.createElement)(F.Path,{d:"M20.2 8v11c0 .7-.6 1.2-1.2 1.2H6v1.5h13c1.5 0 2.7-1.2 2.7-2.8V8zM18 16.4V4.6c0-.9-.7-1.6-1.6-1.6H4.6C3.7 3 3 3.7 3 4.6v11.8c0 .9.7 1.6 1.6 1.6h11.8c.9 0 1.6-.7 1.6-1.6zm-13.5 0V4.6c0-.1.1-.1.1-.1h11.8c.1 0 .1.1.1.1v11.8c0 .1-.1.1-.1.1H4.6l-.1-.1z"}));function Hd({blocks:e}){return(0,s.createElement)("div",{className:"block-editor-block-switcher__popover__preview__parent"},(0,s.createElement)("div",{className:"block-editor-block-switcher__popover__preview__container"},(0,s.createElement)(p.Popover,{className:"block-editor-block-switcher__preview__popover",position:"bottom right",focusOnMount:!1},(0,s.createElement)("div",{className:"block-editor-block-switcher__preview"},(0,s.createElement)("div",{className:"block-editor-block-switcher__preview-title"},(0,g.__)("Preview")),(0,s.createElement)(iu,{viewportWidth:500,blocks:e})))))}var Ud=({className:e,possibleBlockTransformations:t,onSelect:n,blocks:o})=>{const[l,i]=(0,s.useState)();return(0,s.createElement)(p.MenuGroup,{label:(0,g.__)("Transform to"),className:e},l&&(0,s.createElement)(Hd,{blocks:(0,r.switchToBlockType)(o,l)}),t.map((e=>{const{name:t,icon:o,title:l,isDisabled:a}=e;return(0,s.createElement)(p.MenuItem,{key:t,className:(0,r.getBlockMenuDefaultClassName)(t),onClick:e=>{e.preventDefault(),n(t)},disabled:a,onMouseLeave:()=>i(null),onMouseEnter:()=>i(t)},(0,s.createElement)(za,{icon:o,showColors:!0}),l)})))},Gd=window.wp.tokenList,Wd=n.n(Gd);const $d={};function jd({genericPreviewBlock:e,viewportWidth:t,style:n,isActive:o,onBlur:r,onHover:l,onSelect:i,styleClassName:a,itemRole:u}){const d=(0,s.useMemo)((()=>({...e,attributes:{...e.attributes,className:a}})),[e,a]);return(0,s.createElement)("div",{key:n.name,className:c()("block-editor-block-styles__item",{"is-active":o}),onClick:()=>i(),onKeyDown:e=>{fa.ENTER!==e.keyCode&&fa.SPACE!==e.keyCode||(e.preventDefault(),i())},onMouseEnter:l,onMouseLeave:r,role:u||"button",tabIndex:"0","aria-label":n.label||n.name},(0,s.createElement)("div",{className:"block-editor-block-styles__item-preview"},(0,s.createElement)(iu,{viewportWidth:t,blocks:d})),(0,s.createElement)("div",{className:"block-editor-block-styles__item-label"},n.label||n.name))}var Kd=function({clientId:e,onSwitch:t=u.noop,onHoverClassName:n=u.noop,itemRole:o}){const{styles:l,block:i,type:a,className:c}=(0,m.useSelect)((t=>{const{getBlock:n}=t(Wn),o=n(e);if(!o)return $d;const l=(0,r.getBlockType)(o.name),{getBlockStyles:i}=t(r.store);return{block:o,type:l,styles:i(o.name),className:o.attributes.className||""}}),[e]),{updateBlockAttributes:d}=(0,m.useDispatch)(Wn),p=function(e,t){return(0,s.useMemo)((()=>{const n=null==t?void 0:t.example,o=null==t?void 0:t.name;return n&&o?(0,r.getBlockFromExample)(o,{attributes:n.attributes,innerBlocks:n.innerBlocks}):e?(0,r.cloneBlock)(e):void 0}),[null!=t&&t.example?null==e?void 0:e.name:e,t])}(i,a);if(!l||0===l.length)return null;const f=(0,u.find)(l,"isDefault")?l:[{name:"default",label:(0,g._x)("Default","block style"),isDefault:!0},...l],h=function(e,t){for(const n of new(Wd())(t).values()){if(-1===n.indexOf("is-style-"))continue;const t=n.substring(9),o=(0,u.find)(e,{name:t});if(o)return o}return(0,u.find)(e,"isDefault")}(f,c);return(0,s.createElement)("div",{className:"block-editor-block-styles"},f.map((r=>{var l,i;const u=function(e,t,n){const o=new(Wd())(e);return t&&o.remove("is-style-"+t.name),o.add("is-style-"+n.name),o.value}(c,h,r);return(0,s.createElement)(jd,{genericPreviewBlock:p,viewportWidth:null!==(l=null===(i=a.example)||void 0===i?void 0:i.viewportWidth)&&void 0!==l?l:500,className:c,isActive:h===r,key:r.name,onSelect:()=>{d(e,{className:u}),n(null),t()},onBlur:()=>n(null),onHover:()=>n(u),style:r,styleClassName:u,itemRole:o})})))};function qd({hoveredBlock:e,onSwitch:t}){const{name:n,clientId:o}=e,[l,i]=(0,s.useState)(),a=(0,m.useSelect)((e=>e(r.store).getBlockType(n)),[n]);return(0,s.createElement)(p.MenuGroup,{label:(0,g.__)("Styles"),className:"block-editor-block-switcher__styles__menugroup"},l&&(0,s.createElement)(Hd,{blocks:a&&a.example?(0,r.getBlockFromExample)(a.name,{attributes:{...a.example.attributes,className:l},innerBlocks:a.example.innerBlocks}):(0,r.cloneBlock)(e,{className:l})}),(0,s.createElement)(Kd,{clientId:o,onSwitch:t,onHoverClassName:i,itemRole:"menuitem"}))}const Yd=(e,t,n=new Set)=>{const{clientId:o,name:r,innerBlocks:l=[]}=e;if(!n.has(o)){if(r===t)return e;for(const e of l){const o=Yd(e,t,n);if(o)return o}}},Zd=(e,t)=>{const n=((e,t)=>{const n=(0,r.__experimentalGetBlockAttributesNamesByRole)(e,"content");return null!=n&&n.length?n.reduce(((e,n)=>(t[n]&&(e[n]=t[n]),e)),{}):t})(t.name,t.attributes);e.attributes={...e.attributes,...n}};function Xd({patterns:e,onSelect:t}){return(0,s.createElement)("div",{className:"block-editor-block-switcher__popover__preview__parent"},(0,s.createElement)("div",{className:"block-editor-block-switcher__popover__preview__container"},(0,s.createElement)(p.Popover,{className:"block-editor-block-switcher__preview__popover",position:"bottom right"},(0,s.createElement)("div",{className:"block-editor-block-switcher__preview"},(0,s.createElement)("div",{className:"block-editor-block-switcher__preview-title"},(0,g.__)("Preview")),(0,s.createElement)(Qd,{patterns:e,onSelect:t})))))}function Qd({patterns:e,onSelect:t}){const n=(0,p.__unstableUseCompositeState)();return(0,s.createElement)(p.__unstableComposite,i({},n,{role:"listbox",className:"block-editor-block-switcher__preview-patterns-container","aria-label":(0,g.__)("Patterns list")}),e.map((e=>(0,s.createElement)(Jd,{key:e.name,pattern:e,onSelect:t,composite:n}))))}function Jd({pattern:e,onSelect:t,composite:n}){const o="block-editor-block-switcher__preview-patterns-container",r=(0,d.useInstanceId)(Jd,`${o}-list__item-description`);return(0,s.createElement)("div",{className:`${o}-list__list-item`,"aria-label":e.title,"aria-describedby":e.description?r:void 0},(0,s.createElement)(p.__unstableCompositeItem,i({role:"option",as:"div"},n,{className:`${o}-list__item`,onClick:()=>t(e.transformedBlocks)}),(0,s.createElement)(iu,{blocks:e.transformedBlocks,viewportWidth:e.viewportWidth||500}),(0,s.createElement)("div",{className:`${o}-list__item-title`},e.title)),!!e.description&&(0,s.createElement)(p.VisuallyHidden,{id:r},e.description))}var ep=function({blocks:e,patterns:t,onSelect:n}){const[o,l]=(0,s.useState)(!1),i=((e,t)=>(0,s.useMemo)((()=>e.reduce(((e,n)=>{const o=((e,t)=>{const n=t.map((e=>(0,r.cloneBlock)(e))),o=new Set;for(const t of e){let e=!1;for(const r of n){const n=Yd(r,t.name,o);if(n){e=!0,o.add(n.clientId),Zd(n,t);break}}if(!e)return}return n})(t,n.blocks);return o&&e.push({...n,transformedBlocks:o}),e}),[])),[e,t]))(t,e);return i.length?(0,s.createElement)(p.MenuGroup,{className:"block-editor-block-switcher__pattern__transforms__menugroup"},o&&(0,s.createElement)(Xd,{patterns:i,onSelect:n}),(0,s.createElement)(p.MenuItem,{onClick:e=>{e.preventDefault(),l(!o)},icon:wd},(0,g.__)("Patterns"))):null};const tp=({clientIds:e,blocks:t})=>{const{replaceBlocks:n}=(0,m.useDispatch)(Wn),o=kd(t[0].clientId),{possibleBlockTransformations:l,canRemove:i,hasBlockStyles:a,icon:c,blockTitle:d,patterns:f}=(0,m.useSelect)((n=>{var l;const{getBlockRootClientId:i,getBlockTransformItems:s,__experimentalGetPatternTransformItems:a}=n(Wn),{getBlockStyles:c,getBlockType:d}=n(r.store),{canRemoveBlocks:p}=n(Wn),m=i((0,u.castArray)(e)[0]),[{name:f}]=t,g=1===t.length,h=g&&c(f);let b;var v;g?b=null==o?void 0:o.icon:b=1===(0,u.uniq)(t.map((({name:e})=>e))).length?null===(v=d(f))||void 0===v?void 0:v.icon:Vd;return{possibleBlockTransformations:s(t,m),canRemove:p(e,m),hasBlockStyles:!(null==h||!h.length),icon:b,blockTitle:null===(l=d(f))||void 0===l?void 0:l.title,patterns:a(t,m)}}),[e,t,null==o?void 0:o.icon]),h=1===t.length&&(0,r.isReusableBlock)(t[0]),b=1===t.length&&(0,r.isTemplatePart)(t[0]),v=!!l.length&&i,k=!(null==f||!f.length)&&i;if(!a&&!v)return(0,s.createElement)(p.ToolbarGroup,null,(0,s.createElement)(p.ToolbarButton,{disabled:!0,className:"block-editor-block-switcher__no-switcher-icon",title:d,icon:(0,s.createElement)(za,{icon:c,showColors:!0})}));const _=d,y=1===t.length?(0,g.sprintf)(
/* translators: %s: block title. */
(0,g.__)("%s: Change block type or style"),d):(0,g.sprintf)(
/* translators: %d: number of blocks. */
(0,g._n)("Change type of %d block","Change type of %d blocks",t.length),t.length),E=a||v||k;return(0,s.createElement)(p.ToolbarGroup,null,(0,s.createElement)(p.ToolbarItem,null,(o=>(0,s.createElement)(p.DropdownMenu,{className:"block-editor-block-switcher",label:_,popoverProps:{position:"bottom right",isAlternate:!0,className:"block-editor-block-switcher__popover"},icon:(0,s.createElement)(s.Fragment,null,(0,s.createElement)(za,{icon:c,className:"block-editor-block-switcher__toggle",showColors:!0}),(h||b)&&(0,s.createElement)("span",{className:"block-editor-block-switcher__toggle-text"},(0,s.createElement)(_d,{clientId:e}))),toggleProps:{describedBy:y,...o},menuProps:{orientation:"both"}},(({onClose:o})=>E&&(0,s.createElement)("div",{className:"block-editor-block-switcher__container"},k&&(0,s.createElement)(ep,{blocks:t,patterns:f,onSelect:t=>{(t=>{n(e,t)})(t),o()}}),v&&(0,s.createElement)(Ud,{className:"block-editor-block-switcher__transforms__menugroup",possibleBlockTransformations:l,blocks:t,onSelect:l=>{(o=>{n(e,(0,r.switchToBlockType)(t,o))})(l),o()}}),a&&(0,s.createElement)(qd,{hoveredBlock:t[0],onSwitch:o})))))))};var np=({clientIds:e})=>{const t=(0,m.useSelect)((t=>t(Wn).getBlocksByClientId(e)),[e]);return!t.length||t.some((e=>!e))?null:(0,s.createElement)(tp,{clientIds:e,blocks:t})},op=(0,s.createElement)(F.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},(0,s.createElement)(F.Path,{d:"M13 19h-2v-2h2v2zm0-6h-2v-2h2v2zm0-6h-2V5h2v2z"})),rp=window.wp.blob;function lp(){const{getBlockName:e}=(0,m.useSelect)(Wn),{getBlockType:t}=(0,m.useSelect)(r.store),{createSuccessNotice:n}=(0,m.useDispatch)(Su.store);return(0,s.useCallback)(((o,r)=>{let l="";if(1===r.length){var i;const n=r[0],s=null===(i=t(e(n)))||void 0===i?void 0:i.title;l="copy"===o?(0,g.sprintf)(// Translators: Name of the block being copied, e.g. "Paragraph".
